  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(SeoHead, {
        ...
        description:
          'Complete status dashboard for the SFDR Navigator security and compliance remediation plan',
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsx('h1', {
                    ...
                    children: 'Remediation Status Dashboard'
                  }),
                  _jsx('p', {
