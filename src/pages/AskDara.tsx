      ...
      <div className='container max-w-4xl py-8'>
        <div className='flex items-center justify-between mb-6'>
          <div>
            ...
            <p className='text-gray-500 mt-1'>Get expert answers to your GRC questions</p>
          </div>
        ...
        {isSubmitted && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Answered by Dara AI with expert oversight</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='mb-4'>
                <div className='bg-gray-50 p-4 rounded-lg mb-4'>
                  <p className='font-medium text-gray-800'>{sampleResponse.query}</p>
                </div>

                <div className='prose max-w-none'>
                  <div className='whitespace-pre-line'>{sampleResponse.answer}</div>
                </div>
              </div>
              ...
              <div className='bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start'>
                ...
                <div>
                  <h3 className='text-sm font-medium text-amber-800 mb-1'>Disclaimer</h3>
            ...
            <div className='py-4 space-y-6'>
              ...
              <div className='bg-blue-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-gray-700'>
                  Dara combines advanced AI with human expert oversight to provide accurate,
                  up-to-date regulatory guidance. All answers are reviewed for accuracy and include
                  source citations and relevant disclaimers.
                </p>
              </div>
            </div>
