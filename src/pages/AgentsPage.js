    ...
    children: stats.map((stat, index) =>
      _jsxs(
        motion.div,
        {
          ...
          className:
            'group text-center space-y-3 p-4 rounded-2xl hover:bg-muted/50 transition-all duration-300 cursor-pointer',
          whileHover: { scale: 1.05, y: -5 },
          whileTap: { scale: 0.95 },
          children: [
            _jsx('div', {
              className:
                'mx-auto w-16 h-16 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl flex items-center justify-center text-primary group-hover:from-primary/30 group-hover:to-primary/20 transition-all duration-300',
              children: stat.icon
            }),
            _jsx('div', {
              className:
                'text-3xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent',
              children: stat.value
            }),
            _jsx('div', { className: 'text-sm font-medium', children: stat.label }),
            _jsx('div', {
              className:
                'text-xs text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-300',
...
const AgentFilters = ({
  ...
  return _jsxs(motion.div, {
    className:
      'flex flex-col md:flex-row gap-4 items-center justify-between p-6 bg-muted/30 rounded-2xl backdrop-blur-sm',
    ...
    children: [
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('input', {
                ...
                className:
                  'w-full pl-10 pr-4 py-2 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all'
              })
            ]
          }),
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('select', {
                ...
                className:
                  'px-3 py-2 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all capitalize',
                children: categories.map(category =>
                  _jsx(
                    'option',
                    { value: category, children: category === 'all' ? 'All Categories' : category },
                    category
                  )
                )
              })
      ...
      _jsxs('div', {
        className: 'flex items-center gap-2 bg-background rounded-lg p-1',
        children: [
          _jsx(Button, {
            ...
            children: _jsx(Grid, { className: 'w-4 h-4' })
          }),
          _jsx(Button, {
...
const AgentsPage = () => {
  ...
  return _jsxs('div', {
    className:
      'min-h-screen bg-gradient-to-br from-background via-background to-muted/20 relative overflow-hidden',
    children: [
      _jsx(FloatingParticles, {}),
      _jsxs(motion.section, {
        ...
        children: [
          ...
          _jsx('div', {
            className:
              'absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(var(--primary),0.1),transparent_70%)]'
          }),
          _jsx('div', {
            ...
            children: _jsxs(motion.div, {
              ...
              children: [
                _jsxs(Badge, {
                  className:
                    'mb-6 px-6 py-3 text-sm font-medium bg-gradient-to-r from-primary/20 to-primary/10 border-primary/20',
                  children: [
                ...
                _jsx('p', {
                  ...
                  children:
                    'Discover our revolutionary AI agents designed to transform your business operations. From compliance automation to intelligent analytics, experience unprecedented efficiency, accuracy, and innovation.'
                }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs(Button, {
                      size: 'lg',
                      className:
                        'px-8 py-4 text-lg bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70',
                      children: [_jsx(Rocket, { className: 'w-5 h-5 mr-2' }), 'Explore Agents']
                    }),
                    _jsxs(Button, {
                      variant: 'outline',
                      size: 'lg',
                      className: 'px-8 py-4 text-lg border-primary/20 hover:bg-primary/5',
                      children: [_jsx(Clock, { className: 'w-5 h-5 mr-2' }), 'Join Waitlist']
                    })
                  ]
                })
              ]
            ...
            _jsxs(motion.div, {
              ...
              children: [
                ...
                _jsx('p', {
                  ...
                  children:
                    'Our agents leverage cutting-edge artificial intelligence to deliver measurable business outcomes across industries.'
                })
              ]
            }),
            _jsx(InteractiveStats, {})
          ]
        })
      }),
      _jsx(motion.section, {
            ...
            _jsxs(motion.div, {
              ...
              children: [
                _jsx('h2', {
                  ...
                  children: 'Our AI Agent Portfolio'
                }),
                _jsx('p', {
                  className: 'text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed',
                  children:
                    'Each agent is meticulously engineered with specialized capabilities to address specific industry challenges and drive transformational business outcomes.'
                })
              ]
            }),
            _jsx(AgentFilters, {
              ...
              children:
                filteredAgents.length > 0
                  ? filteredAgents.map((agent, index) =>
                      _jsx(EnhancedAgentCard, { agent: agent, index: index }, agent.id)
                    )
                  : _jsxs(motion.div, {
                      initial: { opacity: 0, y: 30 },
                      animate: { opacity: 1, y: 0 },
                      ...
                      children: [
                        _jsx('div', {
                          className:
                            'w-24 h-24 mx-auto bg-muted/50 rounded-full flex items-center justify-center',
                          children: _jsx(Search, { className: 'w-12 h-12 text-muted-foreground' })
                        }),
                        _jsx('h3', {
      ...
      _jsxs(motion.section, {
        ...
        children: [
          ...
          _jsx('div', {
            className:
              'absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,rgba(var(--primary),0.15),transparent_70%)]'
          }),
          _jsxs('div', {
            className: 'relative max-w-5xl mx-auto text-center space-y-10',
            children: [
              _jsxs(motion.div, {
                initial: { opacity: 0, y: 30 },
                ...
                children: [
                  ...
                  _jsx('p', {
                    className: 'text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed',
                    children:
                      'Join the waitlist to be among the first to experience the power of our AI agents. Get early access, exclusive updates, special launch pricing, and dedicated support from our team of experts.'
                  })
                ]
              }),
              _jsxs(motion.div, {
                ...
                children: [
                  _jsxs(Button, {
                    size: 'lg',
                    className:
                      'px-10 py-4 text-lg bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70',
                    children: [_jsx(Star, { className: 'w-5 h-5 mr-2' }), 'Join Early Access']
                  }),
                  _jsxs(Button, {
                    variant: 'outline',
                    size: 'lg',
                    className: 'px-10 py-4 text-lg border-primary/20 hover:bg-primary/5',
                    children: [_jsx(BarChart3, { className: 'w-5 h-5 mr-2' }), 'Schedule Demo']
                  })
                ]
              }),
              _jsxs(motion.div, {
                ...
                children: [
                  _jsxs('div', {
                    className: 'flex items-center gap-2',
                    children: [
                      _jsx(CheckCircle, { className: 'w-4 h-4 text-primary' }),
                      'No setup fees'
                    ]
                  }),
                  _jsxs('div', {
