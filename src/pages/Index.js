...
const Index = () => {
    ...
    return (_jsxs("div", { className: 'min-h-screen relative', children: [_jsx(SeoHead, { title: 'SFDR Navigator - CDD Agent', description: 'Empower your GRC career with Synapse - the intelligence platform where compliance professionals connect, grow, and shape the future.', ogImage: '/lovable-uploads/f88a2e71-50de-4711-83ef-4788c6f169fa.png', structuredData: {
                    organization: {
                ...
                } }), _jsx(AnimatedBackground, {}), _jsx(Navbar, {}), _jsx(HeroSection, {}), _jsx("div", { id: 'features', className: `transition-opacity duration-1000 ${visibleSections.features ? 'opacity-100' : 'opacity-0'}`, children: _jsx(FeaturesSection, {}) }), _jsx(HowItWorksSection, {}), _jsx(NexusAgentSection, {}), _jsx("div", { id: 'testimonials', className: `transition-opacity duration-1000 ${visibleSections.testimonials ? 'opacity-100' : 'opacity-0'}`, children: _jsx(IndustryPerspectivesSection, {}) }), _jsx(Logos3, { heading: 'Powered By', logos: customLogos }), _jsx(EnterpriseSection, {}), _jsx(CTASection, {}), _jsx(Footer, {})] }));
};
