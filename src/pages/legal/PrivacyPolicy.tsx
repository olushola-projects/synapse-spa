      ...
      <div className="flex-grow">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>At Synapse, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the platform.</p>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
              ...
              <p className="text-sm mt-2">We are actively working to ensure compliance with global privacy regulations including GDPR, CCPA, and other relevant frameworks.</p>
            </div>
