          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-600">Your data is encrypted both in transit and at rest using industry-standard protocols and algorithms.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-600">We implement strict role-based access controls with multi-factor authentication for all internal systems.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-600">Our infrastructure is monitored 24/7 with automated threat detection and response capabilities.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-600">We perform regular backups with tested recovery procedures to ensure business continuity.</p>
              </div>
            </div>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">1. Security Overview</h2>
            <p>At Synapse, security is our top priority. We implement comprehensive security measures to protect your data and ensure the integrity of our platform. Our security program is designed with multiple layers of protection and follows industry best practices.</p>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
              ...
              <p className="text-sm mt-2">We are actively working towards compliance with ISO 27001, SOC 2 Type II, and relevant industry standards.</p>
            </div>
            ...
            <p>To report security concerns or for more information about our security practices, please contact us at:</p>
