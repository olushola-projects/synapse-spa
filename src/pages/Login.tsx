          ...
          <div className="bg-card/80 backdrop-blur-sm border border-border/50 shadow-2xl p-8 space-y-8 rounded-2xl py-[162px] px-[72px] mx-0 my-0">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <Button type='submit' disabled={isSubmitting} className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white gap-x-20 shadow-md hover:drop-shadow-md transition-all duration-200 px-[125px] font-normal text-lg">
