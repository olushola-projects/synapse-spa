        ...
        <div className='relative z-10 flex flex-col justify-center px-12 xl:px-16 text-white'>
          <div className='mb-8'>
            <Link to='/' className='inline-block'>
              <h1 className='text-4xl font-bold tracking-tight mb-2 text-white'>Synapse</h1>
            </Link>
            <div className='w-12 h-1 bg-white/60 rounded-full'></div>
          </div>
          
          <h2 className='text-5xl font-bold leading-tight mb-6 text-shadow-md'>
            Welcome to the
          ...
          <div className='bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl shadow-2xl p-8 space-y-8'>
            ...
            <div className='space-y-3'>
              <Button
                variant='outline'
                type='button'
                className='w-full h-12 flex items-center justify-center gap-3 border-2 hover:bg-muted/50 transition-all duration-200 hover:scale-[1.02]'
