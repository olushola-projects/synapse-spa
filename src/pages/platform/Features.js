    ...
    children: [
      ...
      _jsxs('div', {
        ...
        children: [
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Badge, { className: 'mb-4', children: 'Core Capabilities' }),
                    _jsx('h2', {
                      className: 'text-3xl font-bold mb-4',
                      children: 'Comprehensive GRC Intelligence'
                    }),
                    _jsx('p', {
                ...
                _jsx('div', {
                  ...
                  children: [
                    {
                      icon: _jsx(Brain, { className: 'h-8 w-8 text-synapse-primary' }),
                    ...
                    {
                      icon: _jsx(Database, { className: 'h-8 w-8 text-synapse-primary' }),
                    ...
                    {
                      icon: _jsx(Users, { className: 'h-8 w-8 text-synapse-primary' }),
                    ...
                    _jsxs(
                      Card,
                      {
                        ...
                        children: [
                          _jsx('div', {
                            className: 'rounded-full bg-blue-50 p-3 w-fit mb-4',
                          ...
                          _jsx('p', { className: 'text-gray-600', children: feature.description })
                        ]
                      },
                      index
                    )
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  className: 'text-center mb-16',
                  children: [
                    _jsx(Badge, { className: 'mb-4', children: 'Explore Features' }),
                    _jsx('h2', {
                      className: 'text-3xl font-bold mb-4',
                      children: 'Designed for GRC Professionals'
                    }),
                    _jsx('p', {
                      className: 'text-lg text-gray-600 max-w-3xl mx-auto',
                      children:
                            ...
                            _jsxs('div', {
                              children: [
                                _jsx('h3', {
                                  ...
                                  children: 'AI-Powered Compliance Assistance'
                                }),
                                _jsx('p', {
                          ...
                          children: [
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsx('h3', {
                                  className: 'text-2xl font-bold mb-4',
                                  children: 'Comprehensive Regulatory Knowledge'
                                }),
                                _jsx('p', {
                                  className: 'text-gray-600 mb-6',
                                  children:
                          ...
                          children: [
                            _jsxs('div', {
                              children: [
                                _jsx('h3', {
                                  className: 'text-2xl font-bold mb-4',
                                  children: 'Connect with GRC Professionals'
                                }),
                                _jsx('p', {
                                  className: 'text-gray-600 mb-6',
                                  children:
                          ...
                          children: [
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsx('h3', {
                                  className: 'text-2xl font-bold mb-4',
                                  children: 'Data-Driven Compliance Insights'
                                }),
                                _jsx('p', {
                                  className: 'text-gray-600 mb-6',
                                  children:
          ...
          _jsx('section', {
            className: 'bg-synapse-primary py-16',
            children: _jsx('div', {
              className: 'container mx-auto px-4',
              children: _jsxs('div', {
                ...
                children: [
                  _jsx('h2', {
                    className: 'text-3xl font-bold mb-4',
                    children: 'Ready to transform your GRC experience?'
                  }),
                  _jsx('p', {
