...
import { ArrowRight, CheckCircle2, Building, CreditCard, HeartPulse, ShieldCheck, Network, Server } from 'lucide-react';
                    ...
                    <div>
                      ...
                      <div className="mb-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {['GDPR', 'AML', 'KYC', 'Basel III', 'Dodd-Frank', 'FATCA', 'PSD2', 'MiFID II'].map((reg, i) => (
                  ...
                  <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 md:order-2">
                      ...
                      <div className="mb-8">
                        <h4 className="font-semibold mb-3">Key Regulations Covered:</h4>
                        <div className="flex flex-wrap gap-2">
                          {['HIPAA', 'HITECH', 'FDA', 'GxP', 'CLIA', 'PhRMA Code', 'IEC'].map((reg, i) => (
                            <Badge key={i} variant="outline" className="bg-blue-50">
                              {reg}
                            </Badge>
                          ))}
              ...
              {[
                {
                  ...
                  description: "Stay ahead of evolving regulations with automated alerts and impact analysis.",
                  link: "#"
                },
                {
                  title: "Third-Party Risk Management",
                  description: "Assess, monitor, and manage compliance risks in your vendor ecosystem.",
                  link: "#"
                },
                {
                  title: "Policy Management",
                  description: "Create, distribute, and track acknowledgment of policies and procedures.",
                  link: "#"
                },
                {
                  title: "Compliance Training",
                  description: "Deliver and track role-based compliance training across your organization.",
                  link: "#"
                },
                {
                  title: "Audit Management",
                  description: "Streamline internal and external audit processes with centralized evidence collection.",
                  link: "#"
                },
                {
                ...
                <Card key={index} className="hover-lift">
                  ...
                  <CardContent>
                    ...
                    <a href={useCase.link} className="text-synapse-primary font-medium inline-flex items-center hover:underline">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Button size="lg" variant="outline">Download Solutions Guide</Button>
              </div>
            </div>
          </div>
        </section>
