        ...
        <div className='container mx-auto px-4 py-12'>
          ...
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Learn how to use the Synapse platform effectively with our comprehensive
              documentation.
            </p>
            ...
            <div className='grid md:grid-cols-3 gap-6'>
                ...
                <ul className='space-y-2'>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Getting Started Guide <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Navigation & Interface <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
              ...
              <Card className='p-6'>
                ...
                <ul className='space-y-2'>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Regulatory Framework Library <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                  ...
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Evidence Collection <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                </ul>
                <Button variant='ghost' size='sm' className='mt-4 text-gray-600'>
              ...
              <Card className='p-6'>
                ...
                <ul className='space-y-2'>
                  ...
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Asking Effective Questions <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Interpreting Responses <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
              ...
              <Card className='p-6'>
                ...
                <ul className='space-y-2'>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Dashboard Analytics <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
              ...
              <Card className='p-6'>
                ...
                <ul className='space-y-2'>
                  ...
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
                      Available Integrations <ArrowRight className='ml-1 h-3 w-3' />
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-blue-600 hover:underline flex items-center'>
