  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Join our expert-led webinars on governance, risk, and compliance topics. Learn from industry leaders and stay ahead of regulatory changes.'
        />
      </Helmet>
      ...
      <div className='min-h-screen bg-background'>
        ...
        <section className='py-20 bg-gradient-to-br from-primary/5 to-secondary/5'>
          <div className='container mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            <h1 className='text-4xl md:text-6xl font-bold text-foreground mb-6'>GRC Webinars</h1>
            <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
              Stay ahead of regulatory changes and industry best practices with our expert-led
              webinars designed for GRC professionals.
            </p>
          </div>
        </section>
        ...
        <section className='py-16 bg-primary text-primary-foreground'>
          <div className='container mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              Subscribe to our newsletter and get notified about upcoming webinars and exclusive
              content.
            </p>
