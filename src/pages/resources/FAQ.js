...
const FAQ = () => {
    ...
    return (_jsxs("div", { className: 'min-h-screen flex flex-col', children: [_jsx(Navbar, {}), _jsx("section", { className: 'bg-gradient-to-b from-blue-50 to-white pt-24 pb-10', children: _jsx("div", { className: 'container mx-auto px-4', children: _jsxs("div", { className: 'max-w-3xl mx-auto text-center', children: [_jsx("h1", { className: 'text-3xl md:text-4xl font-bold mb-6', children: "How can we help?" }), _jsxs("div", { className: 'relative mx-auto max-w-xl', children: [_jsx("div", { className: 'absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none', children: _jsx(Search, { className: 'h-5 w-5 text-gray-400' }) }), _jsx(Input, { type: 'search', placeholder: 'Search frequently asked questions...', className: 'pl-10 py-6 text-lg rounded-lg', value: searchQuery, onChange: e => setSearchQuery(e.target.value) })] })] }) }) }), _jsx("section", { className: 'border-b', children: _jsx("div", { className: 'container mx-auto px-4', children: _jsx("div", { className: 'flex overflow-x-auto py-4 gap-2 scrollbar-none', children: categories.map(category => (_jsx(Button, { variant: activeCategory === category.id ? 'default' : 'outline', onClick: () => setActiveCategory(category.id), className: 'rounded-full whitespace-nowrap', children: category.name }, category.id))) }) }) }), _jsx("section", { className: 'py-12 flex-grow bg-white', children: _jsx("div", { className: 'container mx-auto px-4', children: _jsxs("div", { className: 'max-w-3xl mx-auto', children: [filteredFaqs.length > 0 ? (_jsx(Accordion, { type: 'single', collapsible: true, className: 'mb-12', children: filteredFaqs.map((faq, index) => (_jsxs(AccordionItem, { value: `item-${index}`, className: 'border-b border-gray-200', children: [_jsx(AccordionTrigger, { className: 'text-lg font-medium py-4 hover:no-underline', children: faq.question }), _jsx(AccordionContent, { className: 'text-gray-600 pb-6', children: _jsx("p", { children: faq.answer }) })] }, index))) })) : (_jsxs("div", { className: 'text-center py-12', children: [_jsx("h3", { className: 'text-xl font-medium mb-2', children: "No results found" }), _jsx("p", { className: 'text-gray-500 mb-8', children: "Try adjusting your search or filter to find what you're looking for" }), _jsx(Button, { onClick: () => {
                                            setSearchQuery('');
                                            setActiveCategory('all');
                                        }, children: "Clear filters" })] })), _jsxs("div", { className: 'mt-12 p-6 bg-blue-50 rounded-lg', children: [_jsx("h3", { className: 'font-bold text-xl mb-3', children: "Still need help?" }), _jsx("p", { className: 'mb-4', children: "Can't find what you're looking for? Our team is here to help." }), _jsx(Button, { children: "Contact Support" })] })] }) }) }), _jsx(Footer, {})] }));
};
export default FAQ;
