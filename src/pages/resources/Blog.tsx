        ...
        <div className='container mx-auto px-4 py-12 relative z-10'>
          <header className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Expert insights, industry trends, and best practices for governance, risk, and
                    ...
                    <>
                      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
                        {currentPosts.map(post => (
                          <Card
                            key={post.id}
                            className='overflow-hidden hover:shadow-md transition-shadow duration-200 bg-white/80 backdrop-blur-sm'
                          >
                            <img
                              src={post.image}
                              alt={post.title}
