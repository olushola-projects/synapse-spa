...
export default function Map() {
  ...
  const analytics = useMemo(() => {
    ...
    const useCaseDistribution = filteredAndSortedStartups.reduce(
      (acc, startup) => {
    ...
    const fundingStageDistribution = filteredAndSortedStartups.reduce(
      (acc, startup) => {
    ...
    const geographyDistribution = filteredAndSortedStartups.reduce(
      (acc, startup) => {
          ...
          <div className='text-center max-w-6xl mx-auto'>
            <div className='inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-full px-4 py-2 mb-6'>
              ...
              <span className='text-sm font-medium text-blue-700'>
                Synapse GRC Intelligence Platform
              </span>
            </div>
            ...
            <p className='text-xl text-gray-600 mb-8 leading-relaxed max-w-4xl mx-auto'>
              Advanced intelligence platform mapping compliance use cases to cutting-edge solution
              providers. Powered by AI-driven matching and real-time market insights.
            </p>
                ...
                <CardContent className='p-4 text-center'>
                  <div className='flex items-center justify-center gap-2 mb-2'>
                    ...
                    <span className='text-2xl font-bold text-purple-700'>
                      {Object.keys(analytics.geographyDistribution).length}
                    </span>
                  </div>
                ...
                <CardContent className='p-4 text-center'>
                  <div className='flex items-center justify-center gap-2 mb-2'>
                    ...
                    <span className='text-2xl font-bold text-orange-700'>
                      {analytics.averageUseCasesPerSolution.toFixed(1)}
                    </span>
                  </div>
                      ...
                      <div className='flex items-center gap-3'>
                        <div className='flex items-center gap-2 text-blue-700'>
                          ...
                          <span className='font-semibold'>
                            {analytics.totalSolutions} solutions found
                          </span>
                        </div>
                ...
                <div className='text-center py-16'>
                  <div className='max-w-md mx-auto'>
                    ...
                    <p className='text-gray-600 mb-8 leading-relaxed'>
                      Try adjusting your filters or search terms. Here are some popular compliance
                      areas to explore:
                    </p>
                  ...
                  <div className='mb-6'>
                    <div className='flex items-center justify-between'>
                      <h2 className='text-lg font-semibold text-gray-900'>
                        {filteredAndSortedStartups.length} Solution
                        {filteredAndSortedStartups.length !== 1 ? 's' : ''} Found
                      </h2>
                                  ...
                                  <div className='flex items-center gap-2'>
                                    ...
                                    >
                                      <Heart
                                        className='h-4 w-4'
                                        fill={
                                          savedSolutions.has(startup.id) ? 'currentColor' : 'none'
                                        }
                                      />
                                    </Button>
                                    <Button
              ...
              {interestedSolutions.size === 0 ? (
                <div className='text-center py-12'>
                  ...
                  <h3 className='text-lg font-medium text-gray-900 mb-2'>
                    No interested solutions yet
                  </h3>
                  <p className='text-gray-500'>
                    Mark solutions you're interested in to track them here.
                  </p>
                </div>
              ) : (
                <div
