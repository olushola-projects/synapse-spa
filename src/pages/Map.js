  ...
  const filteredAndSortedStartups = useMemo(() => {
    const filtered = startups.filter(startup => {
      ...
      if (searchQuery) {
        ...
        const hasMatch =
          queryWords.length === 0 || queryWords.some(word => searchFields.includes(word));
        if (!hasMatch) {
          return false;
        }
      }
      ...
      _jsxs('main', {
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  className:
                    'inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-full px-4 py-2 mb-6',
                  children: [
                    _jsx(Shield, { className: 'h-4 w-4 text-blue-600' }),
                    _jsx('span', {
                      className: 'text-sm font-medium text-blue-700',
                      children: 'Synapse GRC Intelligence Platform'
                    })
                  ]
                }),
                _jsxs('h1', {
                ...
                _jsx('p', {
                  ...
                  children:
                    'Advanced intelligence platform mapping compliance use cases to cutting-edge solution providers. Powered by AI-driven matching and real-time market insights.'
                }),
                _jsxs('div', {
                      ...
                      children: _jsxs(CardContent, {
                        ...
                        children: [
                          _jsxs('div', {
                            ...
                            children: [
                              _jsx(Building2, { className: 'h-5 w-5 text-blue-600' }),
                              _jsx('span', {
                                className: 'text-2xl font-bold text-blue-700',
                                children: analytics.totalSolutions
                              })
                            ]
                          }),
                          _jsx('p', {
                            className: 'text-sm text-blue-600 font-medium',
                            children: 'Active Solutions'
                          })
                        ]
                      })
                    }),
                      ...
                      children: _jsxs(CardContent, {
                        ...
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center justify-center gap-2 mb-2',
                            children: [
                              _jsx(BarChart3, { className: 'h-5 w-5 text-green-600' }),
                              _jsx('span', {
                                className: 'text-2xl font-bold text-green-700',
                                children: analytics.topUseCases.length
                              })
                            ]
                          }),
                          _jsx('p', {
                      ...
                      children: _jsxs(CardContent, {
                        ...
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center justify-center gap-2 mb-2',
                            children: [
                              _jsx(MapPin, { className: 'h-5 w-5 text-purple-600' }),
                              _jsx('span', {
                                className: 'text-2xl font-bold text-purple-700',
                                children: Object.keys(analytics.geographyDistribution).length
                              })
                            ]
                          }),
                          _jsx('p', {
                      ...
                      children: _jsxs(CardContent, {
                        ...
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center justify-center gap-2 mb-2',
                            children: [
                              _jsx(Activity, { className: 'h-5 w-5 text-orange-600' }),
                              _jsx('span', {
                                className: 'text-2xl font-bold text-orange-700',
                                children: analytics.averageUseCasesPerSolution.toFixed(1)
                              })
                            ]
                          }),
                          _jsx('p', {
          ...
          _jsx('div', {
            ...
            children: _jsxs(Tabs, {
              ...
              children: [
                    ...
                    _jsx('div', {
                      ...
                      children: _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx(Input, {
                            placeholder:
                              "Describe your GRC challenge... (e.g., 'AML transaction monitoring', 'GDPR data mapping', 'SOX controls automation')",
                            value: searchQuery,
                            onChange: e => setSearchQuery(e.target.value),
                            className:
                              'pl-12 h-16 text-base border-gray-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80 backdrop-blur-sm'
                          }),
                          searchQuery &&
                            _jsx(Button, {
                              variant: 'ghost',
                              ...
                              className:
                                'absolute right-3 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 hover:bg-gray-100 rounded-full',
                              children: '\u00D7'
                            })
                        ]
                      })
                      ...
                      children: [
                        _jsxs(Select, {
                          ...
                          children: [
                            _jsx(SelectTrigger, {
                              className:
                                'w-48 h-16 border-gray-200 rounded-2xl bg-white/80 backdrop-blur-sm',
                              children: _jsxs('div', {
                                className: 'flex items-center gap-2',
                                children: [
                                  _jsx(BarChart3, { className: 'h-4 w-4 text-gray-500' }),
                            ...
                            _jsxs(SelectContent, {
                              children: [
                                _jsx(SelectItem, { value: 'relevance', children: 'Relevance' }),
                                _jsx(SelectItem, { value: 'name', children: 'Name A-Z' }),
                                _jsx(SelectItem, { value: 'founded', children: 'Newest First' }),
                                _jsx(SelectItem, {
                                  value: 'funding_stage',
                                  children: 'Funding Stage'
                                }),
                                _jsx(SelectItem, { value: 'popularity', children: 'Most Popular' })
                              ]
                            })
                          ]
                        }),
                        _jsxs(Button, {
                          ...
                          className:
                            'lg:hidden h-16 px-6 border-gray-200 rounded-2xl hover:bg-gray-50 bg-white/80 backdrop-blur-sm',
                          children: [
                        ...
                        _jsxs('div', {
                          className:
                            'hidden sm:flex bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-1 shadow-sm',
                          children: [
                            _jsx(Button, {
                              ...
                              children: _jsx(Grid, { className: 'h-4 w-4' })
                            }),
                            _jsx(Button, {
                            ...
                            _jsx(Button, {
                              ...
                              children: _jsx(Layers, { className: 'h-4 w-4' })
                            })
                          ]
                        })
                      ]
                ...
                _jsxs(TabsList, {
                  className:
                    'grid w-full grid-cols-4 lg:w-auto lg:grid-cols-4 bg-gray-100 rounded-2xl p-1 mb-6',
                  children: [
                    _jsxs(TabsTrigger, {
                      value: 'solutions',
                      className:
                        'rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm',
                      children: [_jsx(Building2, { className: 'h-4 w-4 mr-2' }), 'Solutions']
                    }),
                    _jsxs(TabsTrigger, {
                      value: 'analytics',
                      className:
                        'rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm',
                      children: [_jsx(BarChart3, { className: 'h-4 w-4 mr-2' }), 'Analytics']
                    }),
                    _jsxs(TabsTrigger, {
                      value: 'saved',
                      className:
                        'rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm',
                      children: [
                        _jsx(Heart, { className: 'h-4 w-4 mr-2' }),
                        'Saved (',
                        savedSolutions.size,
                        ')'
                      ]
                    ...
                    _jsxs(TabsTrigger, {
                      ...
                      className:
                        'rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm',
                      children: [
                        _jsx(Star, { className: 'h-4 w-4 mr-2' }),
                        'Interested (',
                        interestedSolutions.size,
                        ')'
                      ]
                    })
                  ]
                                ...
                                _jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    _jsxs('span', {
                                      ...
                                      children: [analytics.totalSolutions, ' solutions found']
                                    })
                                  ]
                                }),
                                _jsx('div', {
                                  className: 'flex flex-wrap gap-2',
                                  children: Object.entries(filters).map(([key, values]) =>
                                    values.map(value =>
                                      _jsxs(
                                        Badge,
                                        {
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx(FiltersPanel, {
                className: cn('w-80 shrink-0', 'lg:block', showFilters ? 'block' : 'hidden'),
                filters: filters,
                        ...
                        ? _jsx('div', {
                            ...
                            children: _jsxs('div', {
                              ...
                              children: [
                                _jsx('div', {
                                  className:
                                    'w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6',
                                  children: _jsx(Search, { className: 'h-8 w-8 text-gray-400' })
                                }),
                                _jsx('h3', {
                                  ...
                                  children: [
                                    ...
                                    _jsx(
                                      Button,
                                      {
                                        ...
                                        className:
                                          'border-gray-200 hover:bg-gray-50 hover:border-gray-300 rounded-lg',
                                        children: term
                                      },
                                      term
                                    )
                                ...
                                children: _jsxs('div', {
                                  ...
                                  children: [
                                    _jsxs('h2', {
                                      ...
                                      children: [
                                        filteredAndSortedStartups.length,
                                        ' Solution',
                                      ...
                                      children: _jsxs('table', {
                                        ...
                                        children: [
                                          ...
                                          _jsx('tbody', {
                                            ...
                                            children: displayedStartups.map(startup =>
                                              _jsxs(
                                                'tr',
                                                {
                                                  ...
                                                  children: [
                                                    ...
                                                    _jsx('td', {
                                                      ...
                                                      children: _jsx(Badge, {
                                                        variant: 'outline',
                                                        className: 'text-xs',
                                                        children: startup.funding_stage
                                                      })
                                                    }),
                                                    _jsx('td', {
                                                      className: 'px-6 py-4 text-sm text-gray-900',
                                                      children: startup.geography
                                                    }),
                                                    _jsx('td', {
                                                      className: 'px-6 py-4',
                                                      children: _jsxs('div', {
                                                        ...
                                                        children: [
                                                          _jsx(Button, {
                                                            ...
                                                            className: cn(
                                                              'h-8 w-8 p-0',
                                                              savedSolutions.has(startup.id)
                                                                ? 'text-red-600'
                                                                : 'text-gray-400'
                                                            ),
                                                            children: _jsx(Heart, {
                                                              className: 'h-4 w-4',
                                                              fill: savedSolutions.has(startup.id)
                                                                ? 'currentColor'
                                                                : 'none'
                                                            })
                                                          }),
                                                          _jsx(Button, {
                                                            ...
                                                            size: 'sm',
                                                            onClick: () =>
                                                              toggleInterested(startup.id),
                                                            className: cn(
                                                              'h-8 w-8 p-0',
                                                              interestedSolutions.has(startup.id)
                                                                ? 'text-yellow-600'
                                                                : 'text-gray-400'
                                                            ),
                                                            children: _jsx(Star, {
                                                              className: 'h-4 w-4',
                                                              fill: interestedSolutions.has(
                                                                startup.id
                                                              )
                                                                ? 'currentColor'
                                                                : 'none'
                              ...
                              hasMore &&
                                _jsx('div', {
                                  ...
                                  children: _jsxs(Button, {
                                    ...
                                    className:
                                      'min-w-40 h-12 border-gray-200 hover:bg-gray-50 rounded-xl',
                                    children: [
                                      'Load More Solutions',
                        ...
                        _jsxs(Card, {
                          children: [
                            ...
                            _jsx(CardContent, {
                              children: _jsx('div', {
                                className: 'space-y-4',
                                children: analytics.topUseCases.map(([useCase, count], index) =>
                                  _jsxs(
                                    'div',
                                    {
                                      className: 'flex items-center justify-between',
                                      children: [
                                        _jsxs('div', {
                                          ...
                                          children: [
                                            _jsx('div', {
                                              className:
                                                'w-6 h-6 rounded-full bg-blue-100 text-blue-600 text-xs font-medium flex items-center justify-center',
                                              children: index + 1
                                            }),
                                            _jsx('span', {
                        ...
                        _jsxs(Card, {
                          children: [
                            ...
                            _jsx(CardContent, {
                              children: _jsx('div', {
                                className: 'space-y-4',
                                children: Object.entries(analytics.geographyDistribution)
                                  .sort(([, a], [, b]) => b - a)
                                  .slice(0, 5)
                                  .map(([geography, count]) =>
                                    _jsxs(
                                        ...
                                        children: [
                                          ...
                                          _jsxs('div', {
                                            ...
                                            children: [
                                              _jsx('div', {
                                                className:
                                                  'w-20 h-2 bg-gray-200 rounded-full overflow-hidden',
                                                children: _jsx('div', {
                                              ...
                                              _jsx(Badge, { variant: 'outline', children: count })
                                            ]
                                          })
                                        ]
                                      },
                    ...
                    children:
                      savedSolutions.size === 0
                        ? _jsxs('div', {
                            ...
                            children: [
                              _jsx(Heart, { className: 'mx-auto h-12 w-12 text-gray-400 mb-4' }),
                              _jsx('h3', {
                                className: 'text-lg font-medium text-gray-900 mb-2',
                                children: 'No saved solutions yet'
                              }),
                              _jsx('p', {
                                className: 'text-gray-500',
                                children:
                                  "Save solutions you're interested in to access them quickly later."
                              })
                            ]
                          })
                        : _jsx('div', {
                    ...
                    children:
                      interestedSolutions.size === 0
                        ? _jsxs('div', {
                            className: 'text-center py-12',
                            children: [
                              _jsx(Star, { className: 'mx-auto h-12 w-12 text-gray-400 mb-4' }),
                              _jsx('h3', {
                                className: 'text-lg font-medium text-gray-900 mb-2',
                                children: 'No interested solutions yet'
                              }),
                              _jsx('p', {
                                className: 'text-gray-500',
                                children: "Mark solutions you're interested in to track them here."
                              })
                            ]
                          })
                        : _jsx('div', {
