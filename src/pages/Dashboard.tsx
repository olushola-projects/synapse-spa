...
const availableWidgets: WidgetType[] = [
  { id: "regulation-trend", name: "Regulatory Compliance Trends", description: "Track regulatory trends over time", icon: LineChart },
  { id: "forum-preview", name: "Forum Preview", description: "See the latest discussions from the community", icon: MessageSquare },
