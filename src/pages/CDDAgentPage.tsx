        ...
        <div className='container mx-auto max-w-7xl relative z-10'>
          ...
          >
            <div className='flex justify-center'>
              <Badge variant='secondary' className='px-6 py-3 text-sm font-medium bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20'>
            ...
            >
              ...
              <span className='text-primary font-semibold bg-primary/10 px-2 py-1 rounded'> 99.7% accuracy</span>, 
              <span className='text-primary font-semibold bg-primary/10 px-2 py-1 rounded'> 95% faster processing</span>, and 
              <span className='text-primary font-semibold bg-primary/10 px-2 py-1 rounded'> 60% cost reduction</span>
            </motion.p>
            ...
            >
              {[
                { label: 'Accuracy Rate', value: '99.7%', icon: <Target className='w-8 h-8' />, color: 'from-green-500 to-emerald-600' },
                { label: 'Processing Speed', value: '2.3s', icon: <Zap className='w-8 h-8' />, color: 'from-blue-500 to-cyan-600' },
                { label: 'Cost Reduction', value: '60%', icon: <TrendingUp className='w-8 h-8' />, color: 'from-purple-500 to-indigo-600' },
                { label: 'Global Coverage', value: '50+', icon: <Globe className='w-8 h-8' />, color: 'from-orange-500 to-red-600' }
              ].map((stat, index) => (
                <motion.div
                  key={index}
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className='space-y-12'>
            <div className='flex justify-center'>
              <TabsList className='grid grid-cols-2 md:grid-cols-6 h-auto p-2 bg-muted/50 rounded-2xl'>
                <TabsTrigger value='overview' className='py-4 px-6 data-[state=active]:bg-background data-[state=active]:shadow-lg rounded-xl'>
                  <Eye className='w-4 h-4 mr-2' />
                  Overview
                </TabsTrigger>
                <TabsTrigger value='features' className='py-4 px-6 data-[state=active]:bg-background data-[state=active]:shadow-lg rounded-xl'>
                  <Sparkles className='w-4 h-4 mr-2' />
                  Features
                </TabsTrigger>
                <TabsTrigger value='demo' className='py-4 px-6 data-[state=active]:bg-background data-[state=active]:shadow-lg rounded-xl'>
                  <Play className='w-4 h-4 mr-2' />
                  Live Demo
                </TabsTrigger>
                <TabsTrigger value='architecture' className='py-4 px-6 data-[state=active]:bg-background data-[state=active]:shadow-lg rounded-xl'>
                  <Brain className='w-4 h-4 mr-2' />
                  Architecture
                </TabsTrigger>
                <TabsTrigger value='compliance' className='py-4 px-6 data-[state=active]:bg-background data-[state=active]:shadow-lg rounded-xl'>
                  <Shield className='w-4 h-4 mr-2' />
                  Compliance
                </TabsTrigger>
                <TabsTrigger value='benchmarks' className='py-4 px-6 data-[state=active]:bg-background data-[state=active]:shadow-lg rounded-xl'>
        ...
        <div className='container mx-auto max-w-7xl relative z-10'>
          ...
          >
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
              <Button size='lg' variant='secondary' className='bg-white text-blue-600 hover:bg-blue-50 px-10 py-6 text-lg'>
                Start Free Trial
