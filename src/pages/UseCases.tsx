                  ...
                  >
                    <DialogHeader>
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <DialogTitle className="text-2xl font-bold">{selectedUseCase.title}</DialogTitle>
                          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-2">
                            ...
                            >
                              ...
                              <Badge variant="outline" className={getStatusColor(selectedUseCase.status)}>{selectedUseCase.status}</Badge>
                            </motion.div>
                            <motion.div 
                              className="flex items-center gap-2 text-sm text-gray-600"
                              initial={{ opacity: 0, x: -10 }}
                    ...
                    >
                      <div className="md:col-span-2 space-y-6">
                        ...
                        {selectedUseCase.aiSolution && (
                          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="bg-blue-50 p-4 rounded-lg space-y-2">
                    ...
                    <DialogFooter className="flex justify-between items-center mt-6">
                      <div className="text-sm text-gray-500 flex items-center gap-1">
                        <Clock className="h-4 w-4" />
                        <span>Last updated: {new Date(selectedUseCase.updatedAt || selectedUseCase.createdAt).toLocaleDateString()}</span>
                      </div>
                      <div className="flex gap-2">
