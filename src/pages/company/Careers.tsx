          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Work with experts across GRC, AI, and technology in a supportive environment.</p>
              </div>
              <div className="text-center">
                <div className="bg-[#7A73FF] rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600 text-sm">Build solutions that help professionals navigate complex regulatory landscapes.</p>
              </div>
              <div className="text-center">
                <div className="bg-[#7A73FF] rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600 text-sm">Flexible work arrangements with a global team of talented individuals.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              {openPositions.map((position, index) => (
                <Card key={index} className="border border-gray-200 hover:border-[#7A73FF] transition-colors">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      ...
                      <Button className="bg-[#7A73FF] hover:bg-[#6366F1]">
                        Apply Now
                      </Button>
                    </div>
                  </CardHeader>
