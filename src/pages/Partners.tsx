      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-24 pb-16">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Join our ecosystem of regulatory and compliance professionals and organizations to drive innovation, 
              share knowledge, and create better GRC outcomes together.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
