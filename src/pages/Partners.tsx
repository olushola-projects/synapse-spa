      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-24 pb-16">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Join our ecosystem of regulatory and compliance professionals and
              organizations to drive innovation, share knowledge, and create
              better GRC outcomes together.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We're building a comprehensive ecosystem to connect all
              stakeholders in the regulatory and compliance space. Discover how
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Joining our partner network is simple. Follow these steps to get
              started.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mb-8 text-blue-100">
              Contact our partnership team today to discuss how we can
              collaborate to meet your business objectives.
            </p>
            <Button
              size="lg"
              variant="outline"
            ...
            >
              <Mail className="mr-2 h-4 w-4" /> Contact the Partnership Team
            </Button>
          </div>
        </div>
      </section>
