 ...
 */
router.get('/compliance/rules', authenticateJWT, requireRole(['admin', 'compliance']), async (req, res) => {
  try {
 ...
 */
router.get('/compliance/checks', authenticateJWT, requireRole(['admin', 'compliance']), async (req, res) => {
  try {
 ...
 */
router.get('/performance/alerts', authenticateJWT, requireRole(['admin', 'devops']), async (req, res) => {
  try {
 ...
 */
router.get('/performance/optimizations', authenticateJWT, requireRole(['admin', 'devops']), async (req, res) => {
  try {
 ...
 */
router.post('/performance/reports', authenticateJWT, requireRole(['admin', 'devops']), async (req, res) => {
  try {
 ...
 */
router.get('/errors/circuit-breakers', authenticateJWT, requireRole(['admin', 'devops']), async (req, res) => {
  try {
 ...
 */
router.get('/errors/degradation-strategies', authenticateJWT, requireRole(['admin', 'devops']), async (req, res) => {
  try {
 ...
 */
router.post('/measure-execution-time', authenticateJWT, requireRole(['admin', 'devops']), async (req, res) => {
  try {
    const { name, operation } = req.body;
    
    const result = await performanceOptimizationService.measureExecutionTime(
      name,
      async () => {
        // Simulate the operation
