    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-lg max-h-[90vh] overflow-y-auto'>
        <DialogHeader>
          ...
          <DialogDescription>
            Get early access to our Governance, Risk, and Compliance platform and shape the future
            of GRC.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={handleEmailSignup} className='space-y-4'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
              ...
              <div className='grid gap-2'>
                ...
                <Input id='title' type='text' placeholder='Your position' required />
              </div>
            ...
            <div className='mt-6 space-y-4'>
              <div className='grid gap-2'>
                ...
                <p className='text-xs text-gray-500'>
                  Think about your day-to-day—what would make your work significantly more
                  efficient, insightful, or impactful?
                </p>
                <Textarea
              ...
              <div className='grid gap-2'>
                ...
                <p className='text-xs text-gray-500'>
                  Your perspective will help us understand where existing solutions may fall
                  short—and where new value can be created.
                </p>
                <Textarea
                  id='limiting-tools'
              ...
              <div className='grid gap-2'>
                <Label htmlFor='engagement' className='text-sm font-medium'>
                  How do you currently engage with platforms like LinkedIn, GRC forums, or
                  associations to stay informed, upskill, or solve regulatory challenges?
                </Label>
                <p className='text-xs text-gray-500'>
