...
export const SFDRGem = () => {
  ...
  const handleDocumentUpload = async event => {
    ...
    try {
      for (const file of Array.from(files)) {
        ...
        addMessage(
          'system',
          `Document "${file.name}" analyzed successfully. SFDR relevance: ${mockAnalysis.sfdrRelevance.toFixed(1)}%`
        );
      }
    } catch (error) {
  ...
  const handleClassification = async () => {
    ...
    try {
      ...
      addMessage(
        'agent',
        `Classification complete: ${mockResult.classification} with ${mockResult.confidence.toFixed(1)}% confidence.`
      );
    } catch (error) {
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsxs(Badge, {
                variant: 'secondary',
                className: 'px-3 py-1',
                children: [_jsx(Zap, { className: 'h-4 w-4 mr-1' }), 'MVP']
              })
            ]
          }),
          _jsx('p', {
            ...
            children:
              'Your intelligent SFDR compliance assistant with advanced AI-powered analysis, contextual memory, and seamless export capabilities.'
          })
        ]
      }),
      _jsxs(Card, {
                          ...
                          _jsx(
                            motion.div,
                            {
                              ...
                              children: _jsxs('div', {
                                ...
                                children: [
                                  _jsx('p', { className: 'text-sm', children: message.content }),
                                  _jsx('span', {
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx(Input, {
                        ...
                        placeholder:
                          'Ask about SFDR compliance, regulations, or upload documents...',
                    ...
                    _jsxs(Alert, {
                      children: [
                        ...
                        _jsxs(AlertDescription, {
                          children: [
                            _jsx('strong', { children: 'Context:' }),
                            ' ',
                            contextualMemory.slice(-2).join(' → ')
                          ]
                        })
                      ]
                    })
                          ...
                          _jsx(CardHeader, {
                            children: _jsxs(CardTitle, {
                              ...
                              children: [
                                ...
                                _jsx('span', { children: 'Classification Result' })
                              ]
                            })
                          }),
                          _jsxs(CardContent, {
                                ...
                                children: [
                                  _jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      _jsxs('span', {
                                        children: [classificationResult.confidence.toFixed(1), '%']
                                      })
                                    ]
                                  }),
                                  _jsx(Progress, {
                              ...
                              _jsxs('div', {
                                ...
                                children: [
                                  _jsxs('div', {
                                    className: 'flex items-center justify-between',
                                    children: [
                                      _jsx('span', { children: 'Compliance Score:' }),
                                      _jsxs('span', {
                                        children: [
                              ...
                              _jsxs('div', {
                                children: [
                                  _jsxs('h4', {
                                    ...
                                    children: [
                                      _jsx(TrendingUp, { className: 'h-4 w-4 mr-1' }),
                                      'Recommendations:'
                                    ]
                                  }),
                                  _jsx('ul', {
                                        ...
                                        _jsxs(
                                          'li',
                                          {
                                            ...
                                            children: [
                                              _jsx(CheckCircle, {
                                                className:
                                                  'h-3 w-3 text-green-500 mr-2 mt-1 flex-shrink-0'
                                              }),
                                              rec
                                            ]
                                          },
                              ...
                              classificationResult.issues.length > 0 &&
                                _jsxs('div', {
                                  children: [
                                    ...
                                    _jsx('ul', {
                                      className: 'text-sm space-y-1',
                                      children: classificationResult.issues.map((issue, index) =>
                                        _jsxs(
                                          'li',
                                          {
                                            className: 'flex items-start',
                                            children: [
                                              _jsx(AlertTriangle, {
                                                className:
                                                  'h-3 w-3 text-yellow-500 mr-2 mt-1 flex-shrink-0'
                                              }),
                                              issue
                                            ]
                                          },
              ...
              _jsxs(TabsContent, {
                ...
                children: [
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx(Upload, { className: 'h-12 w-12 text-gray-400 mx-auto mb-4' }),
                      _jsx('h3', {
                                ...
                                children: _jsxs(CardContent, {
                                  ...
                                  children: [
                                    _jsxs('div', {
                                      ...
                                      children: [
                                        _jsxs('div', {
                                          className: 'flex items-center space-x-2',
                                          children: [
                                            _jsx(FileText, { className: 'h-5 w-5 text-blue-500' }),
                                            _jsx('span', {
                                    ...
                                    _jsx('div', {
                                      ...
                                      children: doc.entities.map((entity, i) =>
                                        _jsx(
                                          Badge,
                                          {
                                            variant: 'secondary',
                                    ...
                                    _jsxs('div', {
                                      ...
                                      children: [
                                        _jsxs('span', { children: ['Sentiment: ', doc.sentiment] }),
                                        _jsxs('span', {
                                          children: [doc.topics.length, ' topics identified']
                                        })
                                      ]
                                    })
                                  ]
                    ...
                    _jsxs('div', {
                      children: [
                        ...
                        _jsx('p', {
                          ...
                          children: 'Export your SFDR analysis results in various formats'
                        })
                      ]
                    }),
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx(Card, {
                          ...
                          children: _jsxs(CardContent, {
                            ...
                            children: [
                              _jsx(FileText, { className: 'h-12 w-12 text-red-500 mx-auto mb-3' }),
                              _jsx('h4', {
                                className: 'font-semibold mb-2',
                                children: 'PDF Report'
                              }),
                        ...
                        _jsx(Card, {
                          ...
                          children: _jsxs(CardContent, {
                            className: 'p-6 text-center',
                            children: [
                              _jsx(Download, { className: 'h-12 w-12 text-blue-500 mx-auto mb-3' }),
                              _jsx('h4', {
                                className: 'font-semibold mb-2',
                                children: 'JSON Data'
                              }),
                              _jsx('p', {
                                className: 'text-sm text-muted-foreground',
                                children: 'Raw data for integration with other systems and APIs'
                              })
                            ]
                          })
                        })
                        ...
                        children: [
                          ...
                          _jsxs(AlertDescription, {
                            children: [
                              'Ready to export:',
                              ' ',
                              classificationResult ? '1 classification' : '0 classifications',
                              ',',
