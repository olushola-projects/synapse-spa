    ...
    return render(
      _jsxs(Tabs, {
        ...
        children: [
          _jsxs(TabsList, {
            children: [
              _jsx(TabsTrigger, { value: 'chat', children: 'Chat' }),
              _jsx(TabsTrigger, { value: 'classification', children: 'Classification' }),
              _jsx(TabsTrigger, { value: 'documents', children: 'Documents' })
            ]
          }),
          _jsx(TabsContent, { value: 'chat', children: _jsx(SFDRGem, {}) }),
          _jsx(TabsContent, { value: 'classification', children: _jsx(SFDRGem, {}) }),
          _jsx(TabsContent, { value: 'documents', children: _jsx(SFDRGem, {}) })
        ]
      })
    );
  };
