...
describe('SFDRGem Component', () => {
    ...
    const renderSFDRGem = () => {
        return render(_jsxs(Tabs, { defaultValue: "chat", children: [_jsxs(TabsList, { children: [_jsx(TabsTrigger, { value: "chat", children: "Chat" }), _jsx(TabsTrigger, { value: "classification", children: "Classification" }), _jsx(TabsTrigger, { value: "documents", children: "Documents" })] }), _jsx(TabsContent, { value: "chat", children: _jsx(SFDRGem, {}) }), _jsx(TabsContent, { value: "classification", children: _jsx(SFDRGem, {}) }), _jsx(TabsContent, { value: "documents", children: _jsx(SFDRGem, {}) })] }));
    };
    ...
    describe('Chat Functionality', () => {
        ...
        it('should display AI responses', async () => {
            ...
            await user.click(sendButton);
            await waitFor(() => {
                expect(screen.getByText(/Article 8 funds promote environmental or social characteristics/i)).toBeInTheDocument();
            }, { timeout: 3000 });
        });
    });
