    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            className:
              'absolute -top-[40%] -right-[10%] w-[60%] h-[80%] rounded-full bg-blue-50 blur-3xl opacity-70'
          }),
          _jsx('div', {
            className:
              'absolute -bottom-[20%] -left-[10%] w-[50%] h-[60%] rounded-full bg-indigo-50 blur-3xl opacity-70'
          })
        ]
      }),
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('h2', {
                className:
                  'text-3xl md:text-4xl font-display font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-indigo-700',
                children: 'Modular Solutions'
              }),
              _jsx('p', {
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('div', {
                ...
                children: _jsx(SolutionDetail, { solution: activeSolutionData })
              })
            ]
          })
        ]
