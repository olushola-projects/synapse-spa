...
const HeroSection = () => {
  ...
  return _jsxs('div', {
    ...
    className:
      'w-full py-8 md:py-12 flex flex-col items-start justify-center bg-white relative overflow-hidden lg:py-[60px]',
    children: [
      _jsx('div', {
        className: 'w-full max-w-7xl mx-auto relative z-10',
        children: _jsxs('div', {
          className: 'flex flex-col items-start w-full py-[60px]',
          children: [
            _jsx(HeroContent, {
              animate: animate,
            ...
            _jsx('div', {
              className: `mt-8 w-full pl-4 md:pl-6 lg:pl-8 pr-4 md:pr-6 lg:pr-8 transition-all duration-700 ease-out delay-300 ${animate ? 'opacity-100' : 'opacity-0 translate-y-6'}`,
              children: _jsx(USPFeatureSection, {})
            })
          ]
        })
      }),
