...
const IndustryPerspectivesSection = () => {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('div', {
        className:
          'absolute inset-x-0 top-0 h-24 -z-10 transform -skew-y-6 bg-gradient-to-r from-indigo-50/80 to-blue-50/80'
      }),
      _jsx('div', {
        className:
          'absolute inset-x-0 bottom-0 h-24 -z-10 transform skew-y-6 bg-gradient-to-r from-purple-50/80 to-indigo-50/80'
      }),
      _jsxs('div', {
        className: 'container mx-auto sm:px-6 lg:px-8 relative z-10 bg-white px-0 py-[20px]',
        children: [
          _jsxs('div', {
            className: 'text-center mb-16 max-w-3xl mx-auto',
            children: [
              _jsx('h2', {
                className: 'text-3xl md:text-4xl font-display mb-4 font-semibold',
          ...
          _jsxs('div', {
            className: 'max-w-7xl mx-auto hidden md:block bg-white',
            children: [
              _jsx('div', {
                  ...
                  children: sortedPerspectives.map((perspective, index) =>
                    _jsx(
                      'div',
                      {
                        ...
                        children: _jsx('div', {
                          className: `transition-all duration-500 ease-in-out transform ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`,
                          style: {
                            transitionDelay: `${index * 150}ms`
                          },
                          children: _jsx(Card, {
                            className:
                              'h-[360px] border border-gray-100 hover:border-synapse-primary/20 hover:shadow-md transition-all duration-300 overflow-hidden bg-white rounded-xl',
                            children: _jsxs(CardContent, {
                              className: 'p-6 flex flex-col h-full bg-slate-200',
                              children: [
                                _jsx('div', { className: 'mb-4', children: perspective.icon }),
                                _jsxs('div', {
                                  className: 'mb-5',
                                  children: [
                                    _jsx('h3', {
                                    ...
                                    _jsx('p', {
                                      className: 'text-sm text-synapse-primary/80',
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsx('button', {
                    ...
                    className:
                      'p-2 rounded-full bg-white border border-gray-200 hover:border-primary/50 transition-colors',
                    children: '\u2190'
                  }),
                  _jsx('button', {
                    onClick: () => scrollTo(selectedIndex + 1),
            ...
            children: _jsxs(Carousel, {
              ...
              children: [
                _jsx(CarouselContent, {
                  children: sortedPerspectives.map((perspective, i) =>
                    _jsx(
                      CarouselItem,
                      {
                        className: 'md:basis-1/2 lg:basis-1/3',
                        children: _jsx(PerspectiveCard, {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(CarouselPrevious, {
                      className: 'relative static transform-none bg-white'
                    }),
                    _jsx(CarouselNext, { className: 'relative static transform-none bg-white' })
                  ]
                })
              ]
            })
          }),
          _jsx('div', { className: 'mt-16 text-center' })
        ]
      }),
      _jsx(ArticleDialog, {
        isOpen: isDialogOpen,
...
const PerspectiveCard = ({ perspective, onLearnMore }) =>
  _jsx('div', {
    className: 'h-full',
    children: _jsxs('div', {
      className:
        'h-full flex flex-col p-6 rounded-xl bg-white shadow-sm border border-gray-100 hover:border-synapse-primary/20 hover:shadow-md transition-all duration-300',
      children: [
        _jsx('div', { className: 'mb-4', children: perspective.icon }),
        _jsx('div', {
          className: 'flex-1 mb-4',
          children: _jsx('p', { className: 'text-gray-700 text-sm', children: perspective.bio })
        }),
        _jsxs('div', {
          className: 'mt-auto pt-4 border-t border-gray-100',
          children: [
            _jsx('h3', { className: 'font-bold text-gray-800', children: perspective.name }),
            _jsx('p', { className: 'text-synapse-primary/80 text-xs', children: perspective.role }),
            _jsx('div', {
              className: 'mt-2',
