...
const NexusAgent: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <LoadingFallback variant='detailed' message='Initializing SFDR Navigator...' progress={65} />
    );
  }
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='text-sm text-gray-600 space-y-2'>
              ...
              <p className='text-xs text-blue-600 mt-3'>
                For compliance users: Your data remains secure and no information has been
                compromised.
              </p>
            </div>
