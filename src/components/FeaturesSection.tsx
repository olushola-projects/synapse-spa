      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Synapses provide the tools and community to navigate regulations,
            shape future technologies, and lead the way in AI-driven compliance.
          </p>
        </div>
                    ...
                    >
                      {activeFeature === index ? (
                        ...
                        <div className="flex flex-col h-full justify-between">
                          ...
                          <Button
                            variant="ghost"
                            className="w-fit text-gray-300 gap-2 mt-4 group"
                          >
                            <span>
                              Learn about {feature.title.toLowerCase()}
                            </span>
