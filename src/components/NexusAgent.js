  ...
  const initializeAgent = useCallback(async () => {
    try {
      ...
      const { data: healthData, error: healthError } =
        await supabase.functions.invoke('nexus-health');
        ...
        children: [
          _jsxs(CardHeader, {
            ...
            children: [
              _jsx('div', {
                className:
                  'mx-auto mb-4 w-12 h-12 bg-red-100 rounded-full flex items-center justify-center',
                children: _jsx(WifiOff, { className: 'w-6 h-6 text-red-600' })
              }),
              _jsx(CardTitle, { className: 'text-red-600', children: 'SFDR Navigator Error' })
            ]
          }),
          _jsxs(CardContent, {
            className: 'space-y-4',
            children: [
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsx('p', { children: 'This may be due to:' }),
                  _jsxs('ul', {
                    className: 'list-disc list-inside space-y-1 text-xs',
                    children: [
                      _jsx('li', { children: 'Network connectivity issues' }),
                      _jsx('li', { children: 'Service configuration problems' }),
                      _jsx('li', { children: 'Temporary server maintenance' })
                    ]
                  }),
                  _jsx('p', {
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx(Bot, { className: 'w-8 h-8 text-primary' }),
                  _jsxs('div', {
                    children: [
                      _jsx('h1', {
                      ...
                      _jsx('p', {
                        ...
                        children: 'AI-Powered Compliance Validation'
                      })
                    ]
                  })
                ]
              ...
              _jsxs('nav', {
                ...
                children: [
                  _jsx(Link, {
                    to: '/agents',
                    className:
                      'text-gray-600 hover:text-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-md px-2 py-1',
          ...
          children: [
            _jsxs(TabsList, {
              ...
              children: [
                _jsxs(TabsTrigger, {
                  value: 'chat',
                  className: 'flex items-center gap-2',
                  children: [_jsx(Bot, { className: 'w-4 h-4' }), 'Chat Interface']
                }),
                _jsxs(TabsTrigger, {
                  value: 'overview',
                  className: 'flex items-center gap-2',
                  children: [_jsx(BarChart3, { className: 'w-4 h-4' }), 'Compliance Overview']
                }),
                _jsxs(TabsTrigger, {
                  value: 'testing',
                  className: 'flex items-center gap-2',
                  children: [_jsx(Settings, { className: 'w-4 h-4' }), 'UAT Testing']
                })
              ]
            }),
            _jsx(TabsContent, {
              ...
              children: _jsxs('div', {
                ...
                children: [
                        ...
                        _jsxs(CardContent, {
                          ...
                          children: [
                            _jsxs(Button, {
                              ...
                              variant: 'outline',
                              children: [
                                _jsx(FileCheck, { className: 'w-4 h-4 mr-2' }),
                                'New Analysis'
                              ]
                            }),
                            _jsxs(Button, {
                            ...
                            _jsxs(Button, {
                              ...
                              className: 'w-full justify-start',
                              variant: 'outline',
                              children: [_jsx(Settings, { className: 'w-4 h-4 mr-2' }), 'Run Tests']
                            })
                          ]
                        })
                      ]
                  ...
                  _jsx('div', { className: 'lg:col-span-3', children: _jsx(NexusAgentChat, {}) })
                ]
              })
            }),
            _jsx(TabsContent, {
                    ...
                    children: [
                      _jsx(CardHeader, {
                        children: _jsxs(CardTitle, {
                          className: 'flex items-center gap-2',
                          children: [_jsx(Activity, { className: 'w-5 h-5' }), 'Recent Activity']
                        })
                      }),
                      _jsx(CardContent, {
                        children: _jsx('div', {
                  ...
                  _jsxs(Card, {
                    children: [
                      _jsx(CardHeader, {
                        children: _jsxs(CardTitle, {
                          className: 'flex items-center gap-2',
                          children: [_jsx(Shield, { className: 'w-5 h-5' }), 'System Health']
                        })
                      }),
                      _jsxs(CardContent, {
                        className: 'space-y-4',
                        children: [
                            ...
                            children: [
                              _jsxs('div', {
                                ...
                                children: [
                                  ...
                                  _jsxs('span', {
                                    ...
                                    children: [systemHealth.apiResponseTime, 'ms']
                                  })
                                ]
                              }),
                              _jsxs('div', {
                              ...
                              _jsxs('div', {
                                ...
                                children: [
                                  ...
                                  _jsx('span', {
                                    className: 'text-sm font-medium',
                                    children: systemHealth.activeUsers
                                  })
                                ]
                              })
                            ]
                          ...
                          _jsxs('div', {
                            className: 'flex items-center gap-2',
                            children: [
                              _jsx(Wifi, { className: 'w-4 h-4 text-green-500' }),
                              _jsx('span', {
            ...
            _jsx(TabsContent, {
              ...
              children: _jsxs(Card, {
                children: [
                  _jsx(CardHeader, {
                    children: _jsx(CardTitle, { children: 'UAT Testing Suite' })
                  }),
                  _jsx(CardContent, {
                    children: _jsx('p', {
                      className: 'text-gray-600',
                      children: 'Testing functionality will be available here.'
                    })
                  })
                ]
              })
