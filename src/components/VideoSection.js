...
const VideoSection = () => {
  ...
  return _jsxs('section', {
    ...
    children: [
      _jsx('div', {
        className:
          'absolute inset-0 -z-10 bg-gradient-radial from-blue-50 via-indigo-50 to-purple-50'
      }),
      _jsx('div', {
        className: 'absolute inset-0 -z-10 opacity-30',
        children: _jsx('div', {
          className:
            'absolute inset-0 bg-[linear-gradient(to_right,#8e9ac2,#d8b5c1,#f5d2ae,#d8b5c1,#8e9ac2)] animate-gradient-x'
        })
      }),
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('h2', {
                ...
                children: 'See Synapses in Action'
              }),
              _jsx('p', {
          ...
          _jsxs('div', {
            className:
              'relative max-w-4xl mx-auto aspect-video rounded-xl overflow-hidden shadow-xl',
            children: [
              _jsxs('div', {
                className:
                  'absolute inset-0 bg-gray-900/20 backdrop-blur-sm flex items-center justify-center group cursor-pointer z-10',
                onClick: handlePlayVideo,
                children: [
                  _jsx('div', {
                    className:
                      'w-20 h-20 rounded-full bg-white/90 flex items-center justify-center shadow-lg transition-transform group-hover:scale-110',
                    children: _jsx(Play, { className: 'h-8 w-8 text-blue-600 ml-1' })
                  }),
                  _jsx('div', {
                    className:
                      'absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent',
                    children: _jsxs('div', {
                      className: 'absolute bottom-6 left-6 text-white text-left max-w-md',
                      children: [
                        _jsx('h3', {
                          className: 'text-xl font-bold',
                          children: 'GRC Infrastructure for Modern Professionals'
                        }),
                        _jsx('p', {
                          className: 'text-sm mt-2 text-gray-200',
                          children: 'Learn how Synapses is transforming compliance workflows'
                        }),
                        _jsxs('div', {
                          ...
                          children: [
                            _jsxs(Avatar, {
                              ...
                              children: [
                                _jsx(AvatarImage, {
                                  src: '/lovable-uploads/db02338b-7e4e-46d0-bfe8-e9b9d9005d3f.png',
                                  alt: 'Product Manager'
                                }),
                                _jsx(AvatarFallback, { children: 'JD' })
                              ]
                            }),
                            _jsxs('div', {
                              className: 'ml-2',
          ...
          _jsx('div', {
            ...
            children: _jsxs(Button, {
              ...
              onClick: handlePlayVideo,
              children: ['Watch Full Demo ', _jsx(Play, { className: 'h-4 w-4' })]
            })
          })
        ]
      })
