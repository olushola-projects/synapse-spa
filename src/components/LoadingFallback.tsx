...
export function LoadingFallback({
  ...
  if (variant === 'detailed') {
    return (
      <div className={cn('min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4', className)}>
        <Card className="w-full max-w-2xl shadow-lg">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">Initializing AI-powered regulatory compliance platform</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-muted-foreground">{Math.round(calculatedProgress)}%</span>
              </div>
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      ...
                      {!isActive && !isCompleted && <span className="text-xs text-gray-600">{index + 1}</span>}
                    </div>
