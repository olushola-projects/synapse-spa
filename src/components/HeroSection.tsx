    ...
    <>
      <div className="relative pt-24 pb-8 md:pt-28 md:pb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-6">
          <div className="flex flex-col md:flex-row items-start md:items-start gap-4 lg:gap-0 xl:gap-2">
            ...
            <div className="md:w-1/2">
              <div className={`transition-all duration-700 ease-out ${animateImage ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                <div className="rounded-xl overflow-hidden shadow-xl relative">
                  ...
                  <div className="bg-[#F1F0FB] rounded-md overflow-hidden border border-gray-200/50">
                    <DashboardHeader avatarSrc="/lovable-uploads/06c9cfd1-9bb6-43dd-a1b8-2d3ff1f97ad1.png" />
                    
                    <div className="p-1 flex h-[400px] md:h-[440px] lg:h-[480px] bg-[#F1F0FB]">
                      <SideNavigation onAmlDialogOpen={() => setOpenAmlDialog(true)} />
                      
                      <div className="flex-1 flex flex-col gap-1">
                        <div className="flex justify-between items-center">
                          <div className="text-gray-800 text-xs sm:text-sm font-medium">Regulatory Intelligence Dashboard</div>
                          <div className="flex gap-2 items-center">
                            <div className="text-[9px] sm:text-[11px] text-gray-500">April 29, 2025</div>
                            <div className="flex items-center gap-1">
                              <div className="text-[9px] sm:text-[11px] text-gray-500">Hi, Phoebe Banks</div>
                              <img 
      ...
      <Dialog open={openAmlDialog} onOpenChange={setOpenAmlDialog}>
        <DialogContent className="sm:max-w-3xl max-h-[80vh] overflow-auto">
          <DialogHeader>
            <DialogTitle>AMLD6 Penalties and Criminal Liability Extension</DialogTitle>
            <DialogDescription>
              Understanding the Sixth Anti-Money Laundering Directive's enhanced penalties and criminal liability provisions
            </DialogDescription>
          </DialogHeader>
          <div className="p-6">
