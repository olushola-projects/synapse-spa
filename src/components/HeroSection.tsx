...
const HeroSection = () => {
  ...
  return (
    <div
      ...
      className='w-full py-8 md:py-12 flex flex-col items-start justify-center bg-white relative overflow-hidden lg:py-[60px]'
    >
      {/* Main container with precise alignment matching navbar */}
      <div className='w-full max-w-7xl mx-auto relative z-10'>
        {/* Hero Content - Precisely aligned with navbar logo */}
        <div className='flex flex-col items-start w-full py-[60px]'>
          <HeroContent
            animate={animate}
