...
export const AmlAnalysisCard = ({ onAmlDialogOpen }) => {
  return _jsxs('div', {
      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx(ShieldAlert, { size: 8, className: 'text-red-500' }),
              _jsx('div', {
                className: 'text-gray-800 text-[6px] sm:text-[7px] font-medium',
                children: 'AMLD6 Penalty Analysis'
              })
            ]
          }),
          _jsx('div', {
            className: 'text-red-500 text-[4px] sm:text-[5px] px-1 py-0.5 bg-red-50 rounded-full',
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('h3', {
            ...
            children: 'What is the Penalty under AMLD6 and criminal liability extension?'
          }),
          _jsx('p', {
