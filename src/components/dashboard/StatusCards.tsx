...
export const StatusCards = () => {
  ...
  return (
    <div className="flex gap-1 h-[15%] mb-1">
      ...
      <div className="flex-1 bg-white rounded-md p-1 border border-gray-100 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
        <div className="flex items-center gap-0.5">
          <GamepadIcon size={7} className="text-purple-500" />
      ...
      <Link to="/resources/blog" className="flex-1 bg-white rounded-md p-1 border border-gray-100 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
        <div className="flex items-center gap-0.5">
