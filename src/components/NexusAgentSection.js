      ...
      children: [
        _jsxs(motion.div, {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  className: 'relative',
                  children: [
                    _jsx(Bot, { className: 'w-12 h-12 text-primary' }),
                    _jsx(motion.div, {
            ...
            _jsx('p', {
              className: 'text-gray-600 max-w-3xl mx-auto mb-8 text-base',
              children:
                'Your AI-powered guide to sustainable finance disclosures. Sophia breaks down complex SFDR requirements into actionable steps, ensuring compliant and accurate reporting.'
            }),
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('span', { children: '94% Classification Accuracy' })
                  ]
                }),
                _jsxs('div', {
                  className: 'flex items-center gap-2',
                  children: [
                    _jsx(Zap, { className: 'w-4 h-4 text-yellow-600' }),
                    _jsx('span', { children: '3.2s Average Response' })
                  ]
                }),
                _jsxs('div', {
                  className: 'flex items-center gap-2',
                  children: [
                    _jsx(TrendingUp, { className: 'w-4 h-4 text-blue-600' }),
                    _jsx('span', { children: '500+ Active Users' })
                  ]
                })
              ]
            })
                    ...
                    _jsx(CardHeader, {
                      ...
                      children: _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx(CardTitle, { className: 'text-lg', children: feature.title })
                        ]
                      })
                    }),
                    _jsx(CardContent, {
            ...
            children: _jsxs(CardContent, {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Sparkles, { className: 'w-6 h-6 text-primary' }),
                    _jsx('h3', {
                      className: 'text-2xl font-bold text-gray-900',
                      children: 'Ready to Transform Your SFDR Compliance?'
                    })
                  ]
                }),
                _jsx('p', {
                  ...
                  children:
                    'Experience intelligent SFDR guidance with Sophia. Get instant classifications, compliance validation, and regulatory insights tailored to your fund structure.'
                }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Button, {
                      ...
                      children: _jsxs(Link, {
                        to: '/nexus-agent',
                        className:
                          'bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white font-semibold px-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-200',
                        children: [
                          _jsx(Bot, { className: 'w-5 h-5 mr-2' }),
                          'Try SFDR Navigator',
                          _jsx(ArrowRight, {
