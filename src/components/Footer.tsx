...
const Footer = () => {
  ...
  const socialLinks = [
    { href: 'https://facebook.com/synapsesgrc', icon: Facebook, label: 'Facebook' },
    { href: 'https://twitter.com/synapsesgrc', icon: Twitter, label: 'Twitter' },
    { href: 'https://linkedin.com/company/synapsesgrc', icon: Linkedin, label: 'LinkedIn' },
    { href: 'https://instagram.com/synapsesgrc', icon: Instagram, label: 'Instagram' },
    { href: 'mailto:admin@joinsynapses.com', icon: Mail, label: 'Email' }
  ];

  return (
    <footer className='relative bg-gradient-to-br from-background via-background to-muted/20 border-t border-border/60'>
          ...
          <div className='max-w-2xl mx-auto text-center'>
            ...
            <form onSubmit={handleNewsletterSubmit} className='flex gap-4 max-w-md mx-auto'>
              <Input
                ...
                className='flex-1 bg-background/50 border-border/60 focus:border-primary/60 backdrop-blur-sm'
                required
              />
              <motion.div
              ...
              >
                <Button
                  type='submit'
                  className='bg-gradient-to-r from-primary to-accent hover:from-accent hover:to-primary text-white px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200'
        ...
        <div className='py-12'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            >
              <Link 
                to='/' 
                className='inline-block text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent hover:from-accent hover:to-primary transition-all duration-300'
              >
                Synapses
              </Link>
              ...
              <div className='mt-6 flex space-x-3'>
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    viewport={{ once: true }}
                    className='p-2 rounded-lg bg-background/50 hover:bg-primary/10 border border-border/40 hover:border-primary/30 text-muted-foreground hover:text-primary transition-all duration-200 backdrop-blur-sm'
            ...
            >
              ...
              <ul className='space-y-3'>
                {[
                  { to: '/platform/features', label: 'Features' },
                  { to: '/platform/solutions', label: 'Solutions' },
                  { to: '/#features', label: 'Integrations' },
                  { to: '/ask-dara', label: 'Agent' }
                ].map((link, index) => (
                  <motion.li
                    key={link.to}
