...
export const HeroContent: React.FC<HeroContentProps> = ({ animate, onGetAccess, onLearnMore, onFeatureClick }) => {
  return (
    <div className={`w-full pb-10 md:pb-0 text-left transition-all duration-700 ease-out ${animate ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
      <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-[5rem] font-display font-bold tracking-tight leading-tight text-gray-900 mb-6">
      ...
      <p className="mt-6 text-sm md:text-base text-gray-700 max-w-sm leading-relaxed font-normal">
