    ...
    if (article.content) {
      ...
      dummyAudio.onloadedmetadata = () => {
        ...
        const estimatedDuration = Math.max(
          Math.min((article.content.length / 500) * 60, 1800),
          120
        );
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs(Button, {
                ...
                children: [
                  _jsx(ChevronLeft, { className: 'mr-2 h-4 w-4' }),
                    ...
                    children: [
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsxs('div', {
                            className:
                              'flex flex-wrap items-center gap-3 text-sm text-gray-500 mb-4',
                            children: [
                              _jsx(Badge, {
                                variant: 'outline',
                          ...
                          _jsxs('div', {
                            className: 'flex items-center mb-8 border-b pb-6',
                            children: [
                              _jsxs(Avatar, {
                          ...
                          isPlaying &&
                            _jsxs('div', {
                              className: 'mb-8 bg-gray-50 p-4 rounded-lg flex items-center gap-4',
                              children: [
                                _jsx(Button, {
                                  variant: 'ghost',
                                  size: 'icon',
                                  ...
                                  onClick: toggleAudio,
                                  children: isPlaying
                                    ? _jsx(Pause, { className: 'h-5 w-5' })
                                    : _jsx(Play, { className: 'h-5 w-5' })
                                }),
                                _jsxs('div', {
                                  className: 'flex-1',
                                  children: [
                                    _jsxs('div', {
                                      className: 'text-xs text-gray-500 flex justify-between mb-1',
                                      children: [
                                        _jsx('span', { children: formatTime(currentTime) }),
                                        _jsx('span', { children: formatTime(duration) })
                                      ]
                                    }),
                                    _jsx('div', {
                                ...
                                _jsxs('div', {
                                  ...
                                  children: [
                                    _jsx(Volume2, { className: 'h-4 w-4 text-gray-500' }),
                                    _jsx(Slider, {
                                      value: [volume],
                                      min: 0,
                                      max: 1,
                            ...
                            children: [
                              ...
                              article.content
                                ...
                                : _jsx('p', {
                                    ...
                                    children: 'No content available for this article.'
                                  })
                            ]
                          }),
                          _jsx('div', {
                            ...
                            children: article.tags.map((tag, index) =>
                              _jsxs(
                                ...
                                {
                                  className:
                                    'flex items-center text-xs bg-gray-100 text-gray-800 px-3 py-1.5 rounded-full',
                                  children: [_jsx(Tag, { className: 'w-3 h-3 mr-1' }), ' ', tag]
                                },
                                index
                              )
                            )
                        ...
                        _jsx('div', {
                          ...
                          children: relatedArticles.map(relatedArticle =>
                            _jsxs(
                              ...
                              {
                                className:
                                  'overflow-hidden bg-white/80 backdrop-blur-sm hover:shadow-md transition-all duration-300',
                                children: [
                                  _jsx('img', {
