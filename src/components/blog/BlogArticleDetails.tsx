              ...
              <div className='p-8'>
                ...
                {isPlaying && (
                  <div className='mb-8 bg-gray-50 p-4 rounded-lg flex items-center gap-4'>
                    <Button variant='ghost' size='icon' className='h-10 w-10' onClick={toggleAudio}>
                ...
                <div className='flex flex-wrap gap-2 mt-6'>
                  {article.tags.map((tag, index) => (
                    <span
                      key={index}
                      className='flex items-center text-xs bg-gray-100 text-gray-800 px-3 py-1.5 rounded-full'
                    >
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  {relatedArticles.map(relatedArticle => (
                    <Card
                      ...
                      className='overflow-hidden bg-white/80 backdrop-blur-sm hover:shadow-md transition-all duration-300'
                    >
                      <img
