          ...
          _jsxs('div', {
            children: [
              _jsxs('h1', {
                ...
                children: [_jsx(Brain, { className: 'h-8 w-8' }), 'LLM Strategy Test Suite']
              }),
              _jsx('p', {
                className: 'text-muted-foreground mt-2',
                children: 'Comprehensive testing for Qwen3_235B_A22B and OpenAI gpt-oss-20b models'
              })
            ]
          }),
          _jsxs('div', {
            ...
            children: [
              _jsxs(Button, {
                ...
                variant: 'outline',
                size: 'sm',
                children: [_jsx(Network, { className: 'h-4 w-4 mr-2' }), 'Test Connectivity']
              }),
              _jsxs(Button, {
                ...
                variant: 'outline',
                size: 'sm',
                children: [_jsx(Settings, { className: 'h-4 w-4 mr-2' }), 'Run Validation']
              }),
              _jsx(Button, {
                onClick: runAllTests,
                disabled: isRunning,
                ...
                children: isRunning
                  ? _jsxs(_Fragment, {
                      children: [_jsx(StopCircle, { className: 'h-4 w-4 mr-2' }), 'Stop Tests']
                    })
                  : _jsxs(_Fragment, {
                      children: [_jsx(Play, { className: 'h-4 w-4 mr-2' }), 'Run All Tests']
                    })
              })
            ]
          })
          ...
          children: [
            _jsx(CardHeader, {
              children: _jsxs(CardTitle, {
                ...
                children: [_jsx(Settings, { className: 'h-5 w-5' }), 'Configuration Summary']
              })
            }),
            _jsx(CardContent, {
              children: _jsxs('div', {
                ...
                children: [
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        ...
                        children: configurationSummary.enabledStrategies
                      }),
                      _jsx('div', {
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        className: 'text-2xl font-bold',
                        children: configurationSummary.enabledModels
                      }),
                      _jsx('div', {
                        className: 'text-sm text-muted-foreground',
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        className: 'text-2xl font-bold',
                        children: configurationSummary.defaultStrategy
                      }),
                      _jsx('div', {
                        className: 'text-sm text-muted-foreground',
                        children: 'Default Strategy'
                      })
                    ]
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx(Badge, {
                        className: configurationSummary.validationStatus.valid
                          ? 'bg-green-100 text-green-800'
                          : 'bg-red-100 text-red-800',
                        children: configurationSummary.validationStatus.valid ? 'Valid' : 'Invalid'
                      }),
                      _jsx('div', {
        ...
        _jsxs(Card, {
          children: [
            _jsx(CardHeader, {
              children: _jsxs(CardTitle, {
                className: 'flex items-center gap-2',
                children: [_jsx(Zap, { className: 'h-5 w-5' }), 'Health Status']
              })
            }),
            _jsx(CardContent, {
              children: _jsxs('div', {
                    ...
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx('span', { children: 'Qwen3' })
                        ]
                      }),
                      _jsx(Badge, {
                        className: getHealthStatusColor(healthStatus.qwen.status),
                        children: healthStatus.qwen.status
                      })
                    ]
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      _jsxs('div', {
                        className: 'flex items-center gap-2',
                        children: [
                          _jsx(Cpu, { className: 'h-4 w-4' }),
                          _jsx('span', { children: 'OpenAI' })
                        ]
                      }),
                      _jsx(Badge, {
                        className: getHealthStatusColor(healthStatus.openai.status),
                        children: healthStatus.openai.status
                      })
                    ]
                  }),
                  _jsxs('div', {
                    ...
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx('span', { children: 'Overall' })
                        ]
                      }),
                      _jsx(Badge, {
                        className: getHealthStatusColor(healthStatus.overall),
                        children: healthStatus.overall
                      })
                    ]
                  })
                ]
      ...
      isRunning &&
        _jsxs(Card, {
          children: [
            _jsxs(CardHeader, {
              children: [
                _jsx(CardTitle, { children: 'Test Progress' }),
                _jsxs(CardDescription, {
                  children: ['Overall progress: ', overallProgress.toFixed(1), '%']
                })
              ]
            }),
            _jsxs(CardContent, {
              children: [
                ...
                _jsx('div', {
                  className: 'space-y-2',
                  children: strategyStatuses.map((status, index) =>
                    _jsxs(
                      'div',
                      {
                        className: 'flex items-center justify-between',
                        children: [
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsx('span', { className: 'text-sm', children: status.strategy })
                            ]
                          }),
                          _jsxs('div', {
                            className: 'flex items-center gap-2',
                            children: [
                              _jsx(Progress, { value: status.progress, className: 'w-20' }),
                              _jsx(Badge, {
      ...
      testResults.length > 0 &&
        _jsxs(Card, {
          children: [
            _jsxs(CardHeader, {
              children: [
                _jsx(CardTitle, { children: 'Test Results' }),
                _jsxs(CardDescription, {
                  children: [
                    ...
                    'div',
                    {
                      ...
                      children: [
                          ...
                          children: [
                            _jsxs('div', {
                              ...
                              children: [
                                ...
                                _jsx(Badge, { variant: 'outline', children: result.model }),
                                _jsx(Badge, { variant: 'outline', children: result.provider })
                              ]
                            }),
                            _jsxs('div', {
                              className: 'text-sm text-muted-foreground',
                              children: [result.responseTime, 'ms']
                            })
                          ]
                        }),
                        result.success &&
                            ...
                            children: [
                              ...
                              _jsxs('div', {
                                children: [
                                  ...
                                  _jsxs('div', {
                                    className: 'font-medium',
                                    children: [(result.confidence || 0) * 100, '%']
                                  })
                                ]
                              }),
                              _jsxs('div', {
                        ...
                        result.error &&
                          _jsx('div', {
                            className:
                              'mt-2 p-2 bg-red-50 border border-red-200 rounded text-sm text-red-700',
