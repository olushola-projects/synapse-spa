...
export const NexusTestExecutor = () => {
  ...
  const getStatusIcon = status => {
    ...
    return status
      ...
      : _jsx(XCircle, { className: 'w-4 h-4 text-red-600' });
  };
  const getStatusBadge = status => {
    ...
    return status
      ? _jsx(Badge, { className: 'bg-green-100 text-green-800', children: 'Pass' })
      : _jsx(Badge, { variant: 'destructive', children: 'Fail' });
  };
  return _jsxs('div', {
    className: 'space-y-6',
    children: [
        ...
        children: [
          _jsx(CardHeader, {
            children: _jsxs(CardTitle, {
              ...
              children: [_jsx(Target, { className: 'w-5 h-5' }), 'Nexus Agent UAT Test Suite']
            })
          }),
          _jsxs(CardContent, {
            children: [
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        ...
                        children: Object.keys(automatedResults).length
                      }),
                      _jsx('div', {
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        ...
                        children: testSuite.getTestsByCategory('functional').length
                      }),
                      _jsx('div', {
                        className: 'text-sm text-gray-600',
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        ...
                        children: testSuite.getTestsByCategory('security').length
                      }),
                      _jsx('div', {
                        className: 'text-sm text-gray-600',
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsxs(Button, {
                    ...
                    children: [_jsx(Zap, { className: 'w-4 h-4 mr-2' }), 'Refresh Automated']
                  })
                ]
              }),
              testResults &&
                      ...
                      _jsxs('div', {
                        children: [
                          _jsx('div', {
                            ...
                            children: testResults.totalTests
                          }),
                          _jsx('div', { className: 'text-sm text-gray-600', children: 'Total' })
                        ]
                      }),
                      _jsxs('div', {
                        children: [
      ...
      _jsxs(Card, {
        children: [
          _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Automated Test Results' }) }),
          _jsx(CardContent, {
            children: _jsxs('div', {
              className: 'space-y-3',
              children: [
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('span', { children: 'Chat Interface Initialization' })
                      ]
                    }),
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('span', { children: 'Quick Action Buttons' })
                      ]
                    }),
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('span', { children: 'Responsive Design' })
                      ]
                    }),
      ...
      _jsxs(Card, {
        children: [
          _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Manual Test Actions' }) }),
          _jsx(CardContent, {
            children: _jsxs('div', {
              ...
              children: [
                _jsx(Button, {
                  ...
                  children: _jsxs('div', {
                    className: 'text-center',
                    children: [
                      _jsx('div', { className: 'font-medium', children: 'Test Chat' }),
                      _jsx('div', {
                        className: 'text-sm text-gray-600',
                        children: 'Send SFDR question'
                      })
                    ]
                  })
                }),
                _jsx(Button, {
                  ...
                  children: _jsxs('div', {
                    className: 'text-center',
                    children: [
                      _jsx('div', { className: 'font-medium', children: 'Test Quick Actions' }),
                      _jsx('div', {
                        className: 'text-sm text-gray-600',
                        children: 'Click upload document'
                      })
                    ]
                  })
                }),
                _jsx(Button, {
                  variant: 'outline',
                  onClick: testFormMode,
                  className: 'h-auto py-4',
                  children: _jsxs('div', {
                    className: 'text-center',
                    children: [
                      _jsx('div', { className: 'font-medium', children: 'Test Form Mode' }),
                      _jsx('div', {
                        className: 'text-sm text-gray-600',
                        children: 'Switch to form interface'
                      })
                    ]
                  })
                })
      ...
      _jsxs(Alert, {
        children: [
          ...
          _jsxs(AlertDescription, {
            children: [
              _jsx('strong', { children: 'Testing Instructions:' }),
              _jsx('br', {}),
