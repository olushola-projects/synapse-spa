        ...
        return _jsxs(Alert, {
          ...
          children: [
            ...
            _jsx(AlertDescription, {
              ...
              children:
                '\uD83C\uDF89 Remediation plan completed successfully! All security vulnerabilities have been addressed. The SFDR Navigator is now enterprise-ready and production-secure.'
            })
          ]
        });
      case 'warning':
        ...
        return _jsxs(Alert, {
          ...
          children: [
            ...
            _jsx(AlertDescription, {
              ...
              children: '\uD83D\uDEA8 Critical issues detected. Immediate attention required.'
            })
          ]
        });
    }
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx(Progress, { value: overallProgress, className: 'w-full' })
              ]
            }),
            _jsxs(Tabs, {
              ...
              children: [
                _jsxs(TabsList, {
                  ...
                  children: [
                    ...
                    _jsx(TabsTrigger, { value: 'phases', children: 'Phases' }),
                    _jsx(TabsTrigger, { value: 'testing', children: 'Live Testing' })
                  ]
                }),
                _jsx(TabsContent, {
                  value: 'overview',
                            ...
                            _jsxs(CardHeader, {
                              ...
                              children: [
                                _jsxs('div', {
                                  ...
                                  children: [
                                    _jsx(PhaseIcon, { className: 'h-5 w-5 text-muted-foreground' }),
                                    getStatusBadge(phase.status)
                                  ]
                                }),
                                _jsx(CardTitle, { className: 'text-sm', children: phase.name })
                              ]
                            }),
                            _jsxs(CardContent, {
                              children: [
                                _jsx(Progress, { value: phase.progress, className: 'w-full' }),
                                _jsx('p', {
                              ...
                              _jsxs('div', {
                                ...
                                children: [
                                  _jsxs('div', {
                                    className: 'flex items-center gap-2',
                                    children: [
                                      _jsx(PhaseIcon, { className: 'h-5 w-5' }),
                                      _jsx(CardTitle, { children: phase.name })
                                    ]
                                  }),
                                  getStatusBadge(phase.status)
                                ]
                              }),
                              _jsx(CardDescription, { children: phase.description })
                            ]
                          }),
                          _jsx(CardContent, {
                            children: _jsx('div', {
