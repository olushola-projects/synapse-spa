...
const UATChecklist = () => {
    ...
    const stats = getProgressStats();
    return (_jsxs("div", { className: 'max-w-6xl mx-auto p-6 space-y-6', children: [_jsxs("div", { className: 'text-center space-y-4', children: [_jsx("h1", { className: 'text-3xl font-bold text-gray-900', children: "UAT Testing Checklist" }), _jsx("p", { className: 'text-gray-600 max-w-2xl mx-auto', children: "Comprehensive User Acceptance Testing framework for the Synapses Landing Page. Follow the systematic testing approach to ensure quality and compliance." })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Tester Information" }) }), _jsx(CardContent, { children: _jsxs("div", { className: 'flex gap-4 items-center', children: [_jsx("input", { type: 'text', placeholder: 'Enter your name', value: currentTester, onChange: e => saveTesterName(e.target.value), className: 'flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' }), _jsxs("div", { className: 'flex gap-2', children: [_jsxs(Button, { onClick: exportResults, variant: 'outline', size: 'sm', children: [_jsx(Download, { className: 'h-4 w-4 mr-2' }), "Export Results"] }), _jsxs("label", { className: 'cursor-pointer', children: [_jsx(Button, { variant: 'outline', size: 'sm', asChild: true, children: _jsxs("span", { children: [_jsx(Upload, { className: 'h-4 w-4 mr-2' }), "Import Results"] }) }), _jsx("input", { type: 'file', accept: '.json', onChange: importResults, className: 'hidden' })] }), _jsxs(Button, { onClick: resetResults, variant: 'outline', size: 'sm', children: [_jsx(RotateCcw, { className: 'h-4 w-4 mr-2' }), "Reset"] })] })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Testing Progress" }) }), _jsx(CardContent, { children: _jsxs("div", { className: 'space-y-4', children: [_jsx(Progress, { value: stats.progress, className: 'w-full' }), _jsxs("div", { className: 'grid grid-cols-2 md:grid-cols-4 gap-4 text-center', children: [_jsxs("div", { children: [_jsx("div", { className: 'text-2xl font-bold text-blue-600', children: stats.total }), _jsx("div", { className: 'text-sm text-gray-600', children: "Total Tests" })] }), _jsxs("div", { children: [_jsx("div", { className: 'text-2xl font-bold text-green-600', children: stats.passed }), _jsx("div", { className: 'text-sm text-gray-600', children: "Passed" })] }), _jsxs("div", { children: [_jsx("div", { className: 'text-2xl font-bold text-red-600', children: stats.failed }), _jsx("div", { className: 'text-sm text-gray-600', children: "Failed" })] }), _jsxs("div", { children: [_jsx("div", { className: 'text-2xl font-bold text-gray-600', children: stats.total - stats.completed }), _jsx("div", { className: 'text-sm text-gray-600', children: "Pending" })] })] })] }) })] }), _jsxs(Tabs, { value: selectedCategory, onValueChange: setSelectedCategory, children: [_jsx(TabsList, { className: 'grid w-full grid-cols-3 lg:grid-cols-6', children: testCategories.map(category => {
                            const categoryTests = category.testCases;
                            const completedInCategory = categoryTests.filter(test => {
                                const result = testResults[test.id];
                                return result && result.status !== 'pending';
                            }).length;
                            return (_jsx(TabsTrigger, { value: category.id, className: 'text-xs', children: _jsxs("div", { className: 'flex flex-col items-center', children: [_jsx("span", { children: category.name }), _jsxs(Badge, { variant: 'secondary', className: 'text-xs mt-1', children: [completedInCategory, "/", categoryTests.length] })] }) }, category.id));
                        }) }), testCategories.map(category => (_jsx(TabsContent, { value: category.id, children: _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: category.name }), _jsx("p", { className: 'text-gray-600', children: category.description })] }), _jsx(CardContent, { children: _jsx("div", { className: 'space-y-6', children: category.testCases.map(testCase => {
                                            const result = testResults[testCase.id] || testCase;
                                            const status = result.status || 'pending';
                                            return (_jsxs(Card, { className: 'border-l-4 border-l-gray-200', children: [_jsx(CardHeader, { className: 'pb-3', children: _jsxs("div", { className: 'flex items-start justify-between', children: [_jsxs("div", { className: 'flex-1', children: [_jsxs("div", { className: 'flex items-center gap-2', children: [_jsx("h4", { className: 'font-semibold', children: testCase.title }), _jsx(Badge, { variant: testCase.priority === 'high'
                                                                                        ? 'destructive'
                                                                                        : testCase.priority === 'medium'
                                                                                            ? 'default'
                                                                                            : 'secondary', children: testCase.priority })] }), _jsx("p", { className: 'text-sm text-gray-600 mt-1', children: testCase.description })] }), _jsxs("div", { className: 'flex gap-2', children: [_jsx(Button, { size: 'sm', variant: status === 'passed' ? 'default' : 'outline', onClick: () => updateTestCase(testCase.id, { status: 'passed' }), className: status === 'passed' ? 'bg-green-600 hover:bg-green-700' : '', children: _jsx(Check, { className: 'h-4 w-4' }) }), _jsx(Button, { size: 'sm', variant: status === 'failed' ? 'default' : 'outline', onClick: () => updateTestCase(testCase.id, { status: 'failed' }), className: status === 'failed' ? 'bg-red-600 hover:bg-red-700' : '', children: _jsx(X, { className: 'h-4 w-4' }) }), _jsx(Button, { size: 'sm', variant: status === 'blocked' ? 'default' : 'outline', onClick: () => updateTestCase(testCase.id, { status: 'blocked' }), className: status === 'blocked' ? 'bg-yellow-600 hover:bg-yellow-700' : '', children: _jsx(AlertTriangle, { className: 'h-4 w-4' }) })] })] }) }), _jsx(CardContent, { children: _jsxs("div", { className: 'space-y-4', children: [_jsxs("div", { children: [_jsx("h5", { className: 'font-medium text-sm mb-2', children: "Test Steps:" }), _jsx("ol", { className: 'list-decimal list-inside space-y-1 text-sm text-gray-600', children: testCase.steps.map((step, index) => (_jsx("li", { children: step }, index))) })] }), _jsxs("div", { children: [_jsx("h5", { className: 'font-medium text-sm mb-1', children: "Expected Result:" }), _jsx("p", { className: 'text-sm text-gray-600', children: testCase.expectedResult })] }), _jsxs("div", { children: [_jsx("label", { className: 'font-medium text-sm mb-1 block', children: "Notes & Comments:" }), _jsx(Textarea, { placeholder: 'Add your testing notes, observations, or issues found...', value: result.notes || '', onChange: e => updateTestCase(testCase.id, { notes: e.target.value }), className: 'min-h-[80px]' })] }), result.timestamp && (_jsxs("div", { className: 'text-xs text-gray-500 pt-2 border-t', children: [_jsxs("p", { children: ["Tested by: ", result.testerName || 'Unknown'] }), _jsxs("p", { children: ["Last updated: ", new Date(result.timestamp).toLocaleString()] })] }))] }) })] }, testCase.id));
                                        }) }) })] }) }, category.id)))] }), _jsxs(Alert, { children: [_jsx(AlertTriangle, { className: 'h-4 w-4' }), _jsxs(AlertDescription, { children: [_jsx("strong", { children: "Testing Guidelines:" }), " Test each scenario thoroughly, document any issues found, and provide detailed notes for failed tests. Use the priority levels to focus on critical functionality first. Remember to test across different browsers and devices."] })] })] }));
};
