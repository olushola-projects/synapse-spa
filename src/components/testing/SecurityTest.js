    ...
    try {
      ...
      if (envCheck.exposed) {
        updateTest(
          'Client-Side API Key Exposure',
          'error',
          `CRITICAL: API keys exposed in ${envCheck.files.join(', ')}`,
          'critical',
          envCheck,
          duration
        );
      ...
      updateTest(
        'Client-Side API Key Exposure',
        'error',
        `Failed to check API key exposure: ${error}`,
        'critical',
        error,
        duration
      );
    ...
    try {
      ...
      if (secretsResult.configured) {
        ...
        updateTest(
          'Supabase Secrets Configuration',
          'error',
          'CRITICAL: Supabase secrets not configured',
          'critical',
          secretsResult,
          duration
        );
      ...
      updateTest(
        'Supabase Secrets Configuration',
        'error',
        `Failed to validate secrets: ${error}`,
        'critical',
        error,
        duration
      );
    ...
    try {
      ...
      if (edgeFunctionResult.authenticated) {
        ...
        updateTest(
          'Edge Function Authentication',
          'error',
          'CRITICAL: Edge function authentication failed',
          'critical',
          edgeFunctionResult,
          duration
        );
      ...
      _jsxs(CardHeader, {
        children: [
          _jsxs(CardTitle, {
            ...
            children: [_jsx(Shield, { className: 'h-5 w-5' }), 'Comprehensive Security Test Suite']
          }),
          _jsx(CardDescription, {
            children:
              'Advanced security testing for authentication, rate limiting, and security controls'
          })
        ]
      }),
      _jsxs(CardContent, {
                  ...
                  children: _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', {
                        ...
                        children: metrics.securityScore
                      }),
                      _jsx('p', {
            ...
            _jsxs(Alert, {
              ...
              children: [
                ...
                _jsxs(AlertDescription, {
                  ...
                  children: [
                    _jsx('strong', { children: 'CRITICAL SECURITY ISSUES DETECTED:' }),
                    ' ',
                    metrics.criticalIssues,
                    ' critical security vulnerabilities found. These must be addressed immediately to ensure system security.'
                  ]
                })
              ]
            }),
            ...
            children: [
              _jsx(Button, {
                ...
                children: isRunning
                  ? _jsxs(_Fragment, {
                      children: [
                        _jsx(Clock, { className: 'h-4 w-4 animate-spin' }),
                        'Running Tests...'
                      ]
                    })
                  : _jsxs(_Fragment, {
                      children: [_jsx(Shield, { className: 'h-4 w-4' }), 'Run Security Tests']
                    })
              }),
              _jsxs(Button, {
                variant: 'outline',
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('h3', {
                  ...
                  children: [_jsx(Activity, { className: 'h-5 w-5' }), 'Security Test Results']
                }),
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                ...
                                _jsx(Badge, {
                                  ...
                                  children: test.status.toUpperCase()
                                })
                              ]
                            })
                          ]
                          ...
                          _jsxs('details', {
                            ...
                            children: [
                              _jsx('summary', {
                                ...
                                children: 'View Technical Details'
                              }),
                              _jsx('pre', {
              ...
              children: [
                _jsx(CardHeader, {
                  children: _jsxs(CardTitle, {
                    ...
                    children: [_jsx(Zap, { className: 'h-5 w-5' }), 'Security Metrics']
                  })
                }),
                _jsx(CardContent, {
                  children: _jsxs('div', {
                      ...
                      _jsxs('div', {
                        children: [
                          _jsxs('div', {
                            ...
                            children: [
                              _jsx('span', { children: 'Overall Security Score' }),
                              _jsxs('span', { children: [metrics.securityScore, '%'] })
                            ]
                          }),
                          _jsx(Progress, { value: metrics.securityScore, className: 'h-2' })
                        ]
                      }),
                      _jsxs('div', {
