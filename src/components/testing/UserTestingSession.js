    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            children: [
              _jsx('h1', { className: 'text-3xl font-bold text-gray-900', children: session.name }),
              _jsx('p', { className: 'text-gray-600 mt-1', children: session.description }),
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsxs('span', {
                    ...
                    children: ['Session Time: ', formatTime(sessionTimer)]
                  }),
                  _jsxs('span', {
                    className: 'text-sm text-gray-500',
                    children: ['Task Time: ', formatTime(taskTimer)]
                  })
                ]
              })
            ]
            ...
            children: [
              session.status === 'preparing' &&
                _jsxs(Button, {
                  ...
                  children: [_jsx(Play, { className: 'h-4 w-4 mr-2' }), 'Start Session']
                }),
              session.status === 'active' &&
                _jsxs(_Fragment, {
                  children: [
                    _jsxs(Button, {
                      ...
                      variant: 'outline',
                      children: [_jsx(Pause, { className: 'h-4 w-4 mr-2' }), 'Pause']
                    }),
                    _jsxs(Button, {
                      onClick: endSession,
                      variant: 'destructive',
                      children: [_jsx(Square, { className: 'h-4 w-4 mr-2' }), 'End Session']
                    })
                  ]
                }),
              session.status === 'paused' &&
                _jsxs(_Fragment, {
                  children: [
                    _jsxs(Button, {
                      onClick: startSession,
                      children: [_jsx(Play, { className: 'h-4 w-4 mr-2' }), 'Resume']
                    }),
                    _jsxs(Button, {
                      onClick: endSession,
                      variant: 'destructive',
              ...
              _jsx(Button, { onClick: exportSession, variant: 'outline', children: 'Export Data' })
            ]
          })
        ]
      }),
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx('span', { children: 'Task Progress' }),
                  _jsxs('span', {
                    children: [session.currentTaskIndex + 1, ' of ', session.tasks.length]
                  })
                ]
              }),
        ...
        children: [
          _jsx(CardHeader, {
            children: _jsxs(CardTitle, {
              ...
              children: [_jsx(Camera, { className: 'h-5 w-5' }), 'Recording Controls']
            })
          }),
          _jsx(CardContent, {
            children: _jsxs('div', {
              ...
              children: [
                _jsxs(Button, {
                  ...
                  children: [
                    ...
                    'Screen ',
                    session.recordings.screen ? 'ON' : 'OFF'
                  ]
                }),
                _jsxs(Button, {
                  ...
                  children: [
                    session.recordings.audio
                      ? _jsx(Mic, { className: 'h-4 w-4 mr-2' })
                      : _jsx(MicOff, { className: 'h-4 w-4 mr-2' }),
                    'Audio ',
                    session.recordings.audio ? 'ON' : 'OFF'
                  ]
                }),
                _jsxs(Button, {
                  ...
                  children: [
                    session.recordings.webcam
                      ? _jsx(Camera, { className: 'h-4 w-4 mr-2' })
                      : _jsx(CameraOff, { className: 'h-4 w-4 mr-2' }),
                    'Webcam ',
                    session.recordings.webcam ? 'ON' : 'OFF'
                  ]
                })
              ]
            })
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsxs('div', {
                                ...
                                children: [currentTask.timeLimit, ' min']
                              })
                            ]
                          })
                      ]
                        ...
                        _jsxs('div', {
                          children: [
                            ...
                            _jsx('ol', {
                              ...
                              children: currentTask?.instructions.map((instruction, index) =>
                                _jsx('li', { children: instruction }, index)
                              )
                            })
                          ]
                        }),
                        _jsxs('div', {
                          children: [
                            ...
                            _jsx('p', {
                              ...
                              children: currentTask?.expectedOutcome
                            })
                          ]
                        }),
                        _jsxs('div', {
              ...
              _jsxs(Card, {
                children: [
                  _jsx(CardHeader, {
                    children: _jsxs(CardTitle, {
                      className: 'flex items-center gap-2',
                      children: [_jsx(MessageSquare, { className: 'h-5 w-5' }), 'Add Observation']
                    })
                  }),
                  _jsx(CardContent, {
                    children: _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          ...
                          children: _jsxs('select', {
                            ...
                            children: [
                              _jsx('option', { value: 'observation', children: 'Observation' }),
                              _jsx('option', { value: 'issue', children: 'Issue' }),
                              _jsx('option', { value: 'suggestion', children: 'Suggestion' }),
                              _jsx('option', { value: 'question', children: 'Question' })
                            ]
                          })
                        }),
                        _jsx(Textarea, {
                          placeholder:
                            'Add your observation, note any issues, or record user feedback...',
                          value: newNote,
            ...
            children: [
              ...
              _jsxs(Card, {
                children: [
                  _jsx(CardHeader, {
                    children: _jsxs(CardTitle, {
                      children: ['Recent Notes (', session.notes.length, ')']
                    })
                  }),
                  _jsx(CardContent, {
                    children: _jsxs('div', {
                      ...
                      children: [
                                ...
                                children: [
                                  _jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      _jsx('span', {
                                        className: 'text-xs text-gray-500',
                                        children: new Date(note.timestamp).toLocaleTimeString()
                                      })
                                    ]
                                  }),
                                  _jsx('p', { className: 'text-sm', children: note.content }),
                                  _jsxs('p', {
                                    className: 'text-xs text-gray-500',
                                    children: ['by ', note.author]
                                  })
                                ]
                              },
                              note.id
                        ...
                        session.notes.length === 0 &&
                          _jsx('p', {
                            ...
                            children: 'No notes yet. Start adding observations!'
                          })
                      ]
                    })
                  })
        ...
        _jsxs(Alert, {
          children: [
            ...
            _jsxs(AlertDescription, {
              children: [
                'Session completed! Total duration: ',
