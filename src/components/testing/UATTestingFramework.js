  ...
  return _jsxs('div', {
    ...
    children: [
          ...
          _jsxs('div', {
            children: [
              _jsxs('h2', {
                ...
                children: [_jsx(TestTube, { className: 'h-8 w-8' }), 'UAT Testing Framework']
              }),
              _jsx('p', {
                className: 'text-gray-600',
                children: 'Enhanced SFDR Classification Validation'
              })
            ]
          }),
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx(Button, {
                ...
                disabled: session?.overall_status === 'in_progress',
          ...
          children: [
            _jsx(CardHeader, {
              children: _jsxs(CardTitle, {
                className: 'flex items-center justify-between',
                children: [
                  _jsxs('span', { children: ['Session: ', session.session_id] }),
                  _jsx(Badge, {
                    variant: session.overall_status === 'completed' ? 'default' : 'secondary',
                    children: session.overall_status
                  })
                ]
              })
            }),
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          ...
                          children: session.test_cases.length
                        }),
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          ...
                          children: session.test_cases.filter(tc => tc.status === 'passed').length
                        }),
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          ...
                          children: session.test_cases.filter(tc => tc.status === 'failed').length
                        }),
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          ...
                          children: session.test_cases.filter(tc => tc.status === 'pending').length
                        }),
      ...
      session &&
        _jsxs('div', {
          ...
          children: [
            _jsxs(Card, {
              children: [
                _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Test Cases' }) }),
                _jsx(CardContent, {
                  className: 'space-y-4',
                  children: session.test_cases.map((testCase, index) =>
                    _jsxs(
                      'div',
                      {
                        className: `p-4 border rounded-lg cursor-pointer transition-colors ${currentTestIndex === index ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`,
                        onClick: () => setCurrentTestIndex(index),
                        children: [
                          _jsxs('div', {
                            className: 'flex items-center justify-between mb-2',
                            children: [
                              _jsx('h4', { className: 'font-medium', children: testCase.title }),
                              _jsxs('div', {
                                ...
                                children: [
                                  ...
                                  testCase.status === 'failed' &&
                                    _jsx(XCircle, { className: 'h-5 w-5 text-red-500' }),
                                  testCase.status === 'pending' &&
                                    _jsx(Clock, { className: 'h-5 w-5 text-gray-400' }),
                                  _jsx(Badge, {
                                    variant: 'outline',
                                    children: testCase.expected_classification
                                  })
                                ]
                              })
                            ]
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsxs('div', {
                                  ...
                                  children: [
                                    '\u2713 ',
                                    testCase.results.passed_criteria.length,
                                    ' criteria passed'
                                  ]
                                }),
                                testCase.results.failed_criteria.length > 0 &&
                                  _jsxs('div', {
                                    ...
                                    children: [
                                      '\u2717 ',
                                      testCase.results.failed_criteria.length,
                                      ' criteria failed'
                                    ]
                                  })
                              ]
              ...
              children: [
                _jsx(CardHeader, {
                  children: _jsx(CardTitle, {
                    children: session.test_cases[currentTestIndex]?.title || 'Select a test case'
                  })
                }),
                _jsx(CardContent, {
                  children:
                      ...
                      children: [
                        _jsxs('div', {
                          children: [
                            ...
                            _jsx('p', {
                              className: 'text-sm text-gray-600',
                              children: session.test_cases[currentTestIndex].description
                            })
                          ]
                        }),
                        _jsxs('div', {
                          ...
                          children: [
                            _jsxs('div', {
                              children: [
                                ...
                                _jsx(Badge, {
                                  children:
                                    session.test_cases[currentTestIndex].expected_classification
                                })
                              ]
                            }),
                            _jsxs(Button, {
                              ...
                              disabled:
                                isRunningTest ||
                                session.test_cases[currentTestIndex].status !== 'pending',
                              className: 'flex items-center gap-2',
                              children: [
                        ...
                        _jsxs('div', {
                          children: [
                            ...
                            _jsx('ul', {
                              ...
                              children: session.test_cases[
                                currentTestIndex
                              ].validation_criteria.map((criterion, idx) =>
                                _jsxs(
                                  'li',
                                  {
                                    ...
                                    children: [
                                      _jsx('div', {
                                        className:
                                          'w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0'
                                      }),
                                      _jsx('span', { children: criterion })
                                    ]
                                  },
                                  idx
                                )
      ...
      session &&
        ...
        _jsxs(Card, {
          children: [
            _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Test Results' }) }),
            _jsx(CardContent, {
              children: (() => {
                const currentTest = session.test_cases[currentTestIndex];
                const result = testResults[currentTest.id];
                return result
                  ? _jsx(EnhancedClassificationResult, {
                      result: result,
      ...
      session &&
        ...
        _jsx(Card, {
          children: _jsxs(CardContent, {
            ...
            children: [
              _jsx(CheckCircle, { className: 'h-12 w-12 text-green-500 mx-auto mb-4' }),
              _jsx('h3', {
                className: 'text-lg font-semibold mb-2',
                children: 'All Tests Completed'
              }),
              _jsx('p', {
                className: 'text-gray-600 mb-4',
                children: 'Session ready for completion and report generation'
              }),
              _jsx(Button, {
