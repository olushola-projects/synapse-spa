...
export const USPFeatureSection = () => {
  ...
  return _jsxs('div', {
    className: 'flex flex-col md:flex-row items-start justify-start gap-8 lg:gap-12 rounded-none',
    children: [
        ...
        _jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              _jsx('h3', {
                className:
                  'font-semibold text-slate-800 group-hover:text-blue-600 transition-colors text-sm',
                children: usp.title
              })
            ]
          },
              ...
              _jsxs(DialogHeader, {
                children: [
                  _jsxs(DialogTitle, {
                    ...
                    children: [
                      _jsx('div', {
                        className: `inline-block ${selectedUSP.color}`,
                        children: selectedUSP.icon
                      }),
                      _jsx('span', { children: selectedUSP.title })
                    ]
                  }),
                  _jsx(DialogDescription, {
                    className: 'text-lg text-gray-700 mt-2',
                    children: selectedUSP.description
                  })
                ]
              }),
              _jsxs('div', {
                  ...
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('p', {
                        ...
                        children: selectedUSP.modalContent.position
                      })
                    ]
                  }),
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('p', {
                        className: 'mt-1 text-gray-700',
                        children: selectedUSP.modalContent.problem
                      })
                    ]
                  }),
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('p', {
                        className: 'mt-1 text-gray-700',
                        children: selectedUSP.modalContent.solution
                      })
                    ]
                  }),
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('p', {
                        className: 'mt-1 text-gray-700',
                        children: selectedUSP.modalContent.whyItMatters
                      })
                    ]
                  })
                ]
