...
export const FeatureGrid = () => {
    return (_jsx(FeatureContainer, { children: features.map((feature, index) => (_jsxs(EnhancedFeatureBox, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, children: [_jsx(FeatureIcon, { children: feature.icon }), _jsx(FeatureTitle, { children: feature.title }), _jsx(FeatureDescription, { children: feature.description })] }, index))) }));
};
