    ...
    children: features.map((feature, index) =>
      _jsxs(
        EnhancedFeatureBox,
        {
          ...
          children: [
            _jsx(FeatureIcon, { children: feature.icon }),
            _jsx(FeatureTitle, { children: feature.title }),
            _jsx(FeatureDescription, { children: feature.description })
          ]
        },
        index
      )
