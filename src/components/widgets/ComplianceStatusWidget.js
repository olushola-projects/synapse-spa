...
const ComplianceStatusWidget = ({ onRemove }) => {
  ...
  const CustomTooltip = ({ active, payload }) => {
    if (active && payload && payload.length) {
      return _jsx('div', {
        className: 'bg-white p-2 border rounded shadow-sm text-xs',
        children: _jsx('p', {
      ...
      children: [
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className:
                'flex flex-col items-center justify-center bg-white p-3 rounded-lg border border-gray-100 shadow-sm',
              children: [
                _jsx('h3', {
                ...
                _jsxs('div', {
                  className: 'w-full h-32 mt-2 relative',
                  children: [
                      ...
                      children: _jsxs(PieChart, {
                        children: [
                          _jsx(Pie, {
                            ...
                            startAngle: 180,
                            endAngle: 0,
                            children: riskProfileData.map((entry, index) =>
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('div', { className: 'text-xs text-gray-500', children: 'Score' })
                      ]
                    })
                  ]
                }),
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('span', { children: '50' }),
                        _jsx('span', { children: '100' })
                      ]
                    }),
                    _jsx('div', {
                      className: 'w-full h-2 bg-gray-200 rounded-full mt-1',
                      children: _jsx('div', {
            ...
            _jsxs('div', {
              ...
              children: [
                    ...
                    children: _jsxs(PieChart, {
                      children: [
                        _jsx(Pie, {
                          ...
                          outerRadius: 50,
                          dataKey: 'value',
                          children: controlStatusData.map((entry, index) =>
                            _jsx(Cell, { fill: entry.fill }, `cell-${index}`)
                          )
                        }),
                        _jsx(Tooltip, { content: _jsx(CustomTooltip, {}) })
                ...
                _jsx('div', {
                  ...
                  children: controlStatusData.map((item, index) =>
                    _jsxs(
                      'div',
                      {
                        ...
                        children: [
                          ...
                          _jsx('span', { className: 'font-medium ml-1', children: item.value })
                        ]
                      },
                      index
                    )
            ...
            _jsxs('div', {
              ...
              children: [
                    ...
                    children: _jsxs(PieChart, {
                      children: [
                        _jsx(Pie, {
                          ...
                          outerRadius: 40,
                          dataKey: 'value',
                          children: keyControlsData.map((entry, index) =>
                            _jsx(Cell, { fill: entry.fill }, `cell-${index}`)
                          )
                        }),
                        _jsx(Tooltip, { content: _jsx(CustomTooltip, {}) })
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('div', { className: 'text-2xl font-bold text-blue-700', children: '267' }),
                    _jsx('div', { className: 'text-xs text-gray-500', children: 'Key Controls' }),
                    _jsx('div', {
                      className: 'space-y-1 mt-2',
                      children: keyControlsData.map((item, index) =>
                        _jsxs(
                          'div',
                          {
                            className: 'flex items-center text-xs',
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: 'flex justify-between items-center',
              children: [
                _jsx('div', { className: 'text-gray-500', children: 'Last assessment:' }),
                _jsx('div', { className: 'font-medium', children: 'April 12, 2023' })
              ]
            }),
            _jsxs('div', {
              className: 'flex justify-between items-center mt-1',
              children: [
                _jsx('div', { className: 'text-gray-500', children: 'Next assessment due:' }),
                _jsx('div', { className: 'font-medium', children: 'June 15, 2023' })
              ]
            })
          ]
        })
