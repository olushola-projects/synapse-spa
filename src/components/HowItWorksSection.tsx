      ...
      <div className='container mx-auto sm:px-6 lg:px-8 px-[50px] py-[10px]'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          {steps.map((step, index) => <div key={index} className='relative'>
              ...
              {index < steps.length - 1 && <div className='hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-synapse-primary to-transparent z-0' style={{
            width: 'calc(100% - 2rem)'
          }}></div>}
