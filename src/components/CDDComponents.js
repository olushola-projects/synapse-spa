    ...
    children: metrics.map((metric, index) =>
      _jsxs(
        motion.div,
        {
          ...
          className: `relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br ${metric.color} text-white cursor-pointer transform transition-all duration-300 hover:scale-105 ${activeMetric === index ? 'ring-4 ring-white/30 scale-105' : ''}`,
          ...
          children: [
            ...
            _jsx('h3', { className: 'font-semibold text-lg mb-2', children: metric.label }),
            _jsx('p', { className: 'text-sm text-white/80 mb-4', children: metric.description }),
            _jsxs('div', {
              className: 'space-y-2',
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('span', { children: 'Performance' }),
                    _jsxs('span', { children: [metric.value, '%'] })
                  ]
                }),
                _jsx(Progress, { value: metric.value, className: 'h-2 bg-white/20' })
              ]
            }),
            _jsx(motion.div, {
        ...
        children: features.map((feature, index) =>
          _jsxs(
            motion.button,
            {
              ...
              children: [
                _jsx('div', {
                  className: `p-3 rounded-xl mb-4 inline-block ${activeFeature === index ? 'bg-white/20' : 'bg-primary/10'}`,
                  children: feature.icon
                }),
                _jsx('h3', { className: 'font-semibold text-lg mb-2', children: feature.title }),
                _jsx('p', {
                  className: `text-sm ${activeFeature === index ? 'text-white/80' : 'text-muted-foreground'}`,
          ...
          motion.div,
          {
            ...
            children: _jsxs('div', {
              ...
              children: [
                  ...
                  children: [
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('ul', {
                          className: 'space-y-2',
                          children: features[activeFeature]?.details?.map((detail, idx) =>
                            _jsxs(
                              motion.li,
                              {
                                ...
                                children: [
                                  _jsx('div', { className: 'w-2 h-2 bg-primary rounded-full' }),
                                  detail
                                ]
                              },
                              idx
                    ...
                    _jsxs(Button, {
                      ...
                      children: [
                        ...
                        'Try ',
                        features[activeFeature]?.demo || 'Demo'
                      ]
                    })
                  ]
                }),
                _jsx('div', {
                  className:
                    'bg-muted/50 rounded-2xl p-8 flex items-center justify-center min-h-[300px]',
                  children: _jsxs('div', {
                    ...
                    children: [
                      ...
                      _jsx('h4', {
                        ...
                        children: features[activeFeature]?.demo || 'Demo'
                      }),
                      _jsx('p', {
    ...
    children: standards.map((standard, index) =>
      _jsxs(
        motion.div,
        {
          ...
          children: [
            _jsx('div', { className: 'flex justify-center', children: standard.icon }),
            _jsx('h4', { className: 'font-semibold text-sm', children: standard.name }),
            _jsx('p', { className: 'text-xs text-white/80', children: standard.region })
          ]
        },
        index
      )
    ...
    children: layers.map((layer, index) =>
      _jsxs(
        motion.div,
        {
          ...
          children: [
            _jsx('div', {
              className: `p-6 rounded-2xl bg-gradient-to-r ${layer.color} text-white`,
              children: _jsxs('div', {
                className: 'flex items-center gap-4',
                children: [
                  _jsx('div', { className: 'p-3 bg-white/20 rounded-xl', children: layer.icon }),
                  _jsxs('div', {
                    className: 'flex-1',
                    children: [
                      _jsx('h3', { className: 'text-xl font-semibold mb-2', children: layer.name }),
                      _jsx('p', { className: 'text-white/80', children: layer.description })
                    ]
                  }),
                  _jsx(ChevronRight, { className: 'w-6 h-6' })
                ]
              })
            }),
            index < layers.length - 1 &&
              _jsx('div', {
                ...
                children: _jsx('div', { className: 'w-px h-8 bg-border' })
              })
          ]
        },
        index
...
export const PerformanceBenchmarks = () => {
  ...
  return _jsx('div', {
    ref: ref,
    className: 'space-y-6',
    children: benchmarks.map((benchmark, index) => {
        ...
        motion.div,
        {
          ...
          children: [
            _jsxs('div', {
              className: 'flex items-center justify-between mb-4',
              children: [
                _jsx('h4', { className: 'font-semibold text-lg', children: benchmark.metric }),
                isOursBetter &&
                  _jsxs(Badge, {
                    variant: 'secondary',
                    className: 'bg-green-100 text-green-800',
                    children: [_jsx(TrendingUp, { className: 'w-3 h-3 mr-1' }), 'Leading']
                  })
              ]
            }),
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs('span', {
                      className: 'font-semibold text-lg',
                      children: [benchmark.ourScore, benchmark.unit]
                    })
                  ]
                }),
                _jsx(Progress, {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs('span', {
                      ...
                      children: [benchmark.industry, benchmark.unit]
                    })
                  ]
                }),
                _jsx(Progress, {
    ...
    children: [
      _jsx('div', {
        ...
        children: _jsx('div', {
          ...
          children: stories.map((_, index) =>
            _jsx(
              'button',
              {
                onClick: () => setActiveStory(index),
                className: `w-3 h-3 rounded-full transition-all ${activeStory === index ? 'bg-primary' : 'bg-muted'}`
              },
              index
            )
          )
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          className: 'text-4xl',
                          children: stories[activeStory]?.logo
                        }),
                        _jsxs('div', {
                          children: [
                            _jsx('h3', {
                              className: 'text-2xl font-bold',
                              children: stories[activeStory]?.company
                            }),
                            _jsx('p', {
                              className: 'text-muted-foreground',
                              children: stories[activeStory]?.industry
                            })
                          ]
                        })
                      ]
                      ...
                      children: [
                        _jsxs('div', {
                          children: [
                            ...
                            _jsx('p', {
                              className: 'text-sm',
                              children: stories[activeStory]?.challenge
                            })
                          ]
                        }),
                        _jsxs('div', {
                          children: [
                            ...
                            _jsx('p', {
                              className: 'text-sm',
                              children: stories[activeStory]?.solution
                            })
                          ]
                        })
                      ]
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      children: [
                        _jsx('h4', {
                          className: 'font-semibold text-green-600 mb-4',
                          children: 'Results'
                        }),
                        _jsx('ul', {
                          className: 'space-y-2',
                          children: stories[activeStory]?.results?.map((result, idx) =>
                            _jsxs(
                              'li',
                              {
                                className: 'flex items-center gap-3 text-sm',
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsxs('blockquote', {
                          ...
                          children: ['"', stories[activeStory]?.quote, '"']
                        }),
                        _jsxs('cite', {
                          className: 'text-xs text-muted-foreground font-medium',
                          children: ['\u2014 ', stories[activeStory]?.author]
                        })
                      ]
                    })
                  ]
