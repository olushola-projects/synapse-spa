...
const HowItWorksSection = () => {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        className: 'container mx-auto sm:px-6 lg:px-8 px-[50px] py-[10px]',
        children: [
          _jsxs('div', {
                ...
                'div',
                {
                  ...
                  children: [
                    index < steps.length - 1 &&
                      _jsx('div', {
                        className:
                          'hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-synapse-primary to-transparent z-0',
                        style: {
                          width: 'calc(100% - 2rem)'
                        }
                      }),
                    _jsxs('div', {
                      className: 'feature-card h-full relative z-10 bg-slate-200',
                      children: [
                        _jsx('div', {
