...
export function FiltersPanel({ className, filters, onFiltersChange, startups }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('div', {
                className: 'p-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg',
                children: _jsx(Filter, { className: 'h-5 w-5 text-blue-600' })
              }),
              _jsxs('div', {
                children: [
                  _jsx('h3', {
                  ...
                  _jsx('p', { className: 'text-sm text-gray-500', children: 'Refine your search' })
                ]
              }),
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('h4', {
              ...
              children: [
                _jsx('span', { className: 'w-2 h-2 bg-blue-500 rounded-full' }),
                'Active Filters'
              ]
            }),
            _jsx('div', {
              className: 'flex flex-wrap gap-2',
              children: Object.entries(filters).map(([category, values]) =>
                values.map(value =>
                  _jsxs(
                    Badge,
                    {
                      className:
                        'flex items-center gap-1 pr-1 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 transition-colors',
                      children: [
                        _jsx('span', { className: 'text-xs truncate max-w-24', children: value }),
                        _jsx('button', {
                          onClick: () => removeFilter(category, value),
                          className:
                            'ml-1 hover:bg-red-100 hover:text-red-600 rounded-full p-0.5 transition-colors',
      ...
      _jsx('div', {
        className: 'space-y-4',
        children: filterSections.map(({ key, label, icon }) => {
              ...
              children: [
                _jsx(CollapsibleTrigger, {
                  ...
                  children: _jsxs(Button, {
                    variant: 'ghost',
                    className:
                      'w-full justify-between p-4 h-auto hover:bg-gray-50 border border-transparent hover:border-gray-200 rounded-lg transition-all duration-200',
                    children: [
                      _jsxs('div', {
                        className: 'flex items-center gap-3',
                        children: [
                          _jsx('span', { className: 'text-lg', children: icon }),
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              activeFilters.length > 0 &&
                                _jsx(Badge, {
                                  className:
                                    'bg-blue-100 text-blue-700 border-blue-200 text-xs px-2 py-0.5',
                ...
                _jsx(CollapsibleContent, {
                  className: 'pt-3 pb-4',
                  children: _jsx('div', {
                    className: 'space-y-3 max-h-48 overflow-y-auto pl-4 pr-2',
                    children: options.map(option =>
                      _jsxs(
                        'div',
                        {
                          className:
                            'flex items-center space-x-3 group hover:bg-gray-50 p-2 rounded-md transition-colors',
                          children: [
                            _jsx(Checkbox, {
                            ...
                            _jsx('label', {
                              ...
                              className:
                                'text-sm font-medium text-gray-700 cursor-pointer flex-1 leading-relaxed group-hover:text-gray-900 transition-colors',
                              children: option
                            })
                          ]
                        },
