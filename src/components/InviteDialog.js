  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { className: 'text-xl', children: 'Invite a Colleague' }),
            ...
            children: [
              _jsx(FormField, {
                ...
                render: ({ field }) =>
                  _jsxs(FormItem, {
                    children: [
                      _jsx(FormLabel, { children: 'Your Name' }),
                      _jsx(FormControl, {
                        children: _jsx(Input, { placeholder: 'John Doe', ...field })
                      }),
                      _jsx(FormMessage, {})
                    ]
                  })
              ...
              _jsx(FormField, {
                ...
                render: ({ field }) =>
                  _jsxs(FormItem, {
                    children: [
                      _jsx(FormLabel, { children: 'Your Email' }),
                      _jsx(FormControl, {
                        children: _jsx(Input, {
              ...
              _jsx(FormField, {
                ...
                render: ({ field }) =>
                  _jsxs(FormItem, {
                    children: [
                      _jsx(FormLabel, { children: "Invitee's Email" }),
                      _jsx(FormControl, {
                        children: _jsx(Input, {
              ...
              _jsx(FormField, {
                ...
                render: ({ field }) =>
                  _jsxs(FormItem, {
                    children: [
                      _jsx(FormLabel, { children: 'Message (Optional)' }),
                      _jsx(FormControl, {
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx(Button, {
                    ...
                    children: isSubmitting ? 'Sending...' : 'Send Invitation'
                  })
                ]
              })
            ]
