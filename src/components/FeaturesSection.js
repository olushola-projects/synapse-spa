...
const FeaturesSection = () => {
  ...
  return _jsxs('section', {
    ...
    children: [
      ...
      _jsx('div', {
        className:
          'absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(120,119,198,0.05),transparent_50%)] rounded-none bg-gray-50'
      }),
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('h2', {
                className:
                  'text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent',
                children: 'Transform Your GRC Workflow'
              }),
              _jsx('p', {
                className:
                  'text-muted-foreground max-w-4xl mx-auto leading-relaxed text-lg font-medium',
                children:
                  "Discover AI-driven tools that revolutionize compliance management, enhance career growth, and connect you with the world's leading GRC professionals."
              })
            ]
          }),
          _jsx('div', {
                        ...
                        children: _jsxs(Card, {
                          ...
                          children: [
                            activeFeature === index &&
                              _jsx('div', {
                                className:
                                  'absolute inset-0 bg-gradient-to-br from-primary/5 to-accent/5 pointer-events-none'
                              }),
                            _jsx(CardContent, {
                              className: cn(
                              ...
                              children:
                                activeFeature === index
                                    ...
                                    _jsxs('div', {
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            _jsxs('div', {
                                              ...
                                              children: [
                                                _jsx('h3', {
                                                  className:
                                                    'text-2xl font-display font-bold text-foreground leading-tight',
                                        ...
                                        _jsxs(Button, {
                                          variant: 'ghost',
                                          className:
                                            'w-fit text-muted-foreground hover:text-foreground gap-3 mt-6 group/btn p-0 h-auto',
                                          children: [
                                            _jsxs('span', {
                                              className: 'text-sm font-medium',
                                              children: ['Explore ', feature.title]
                                            }),
                                            _jsx('div', {
                                              className:
                                                'w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center group-hover/btn:bg-primary group-hover/btn:text-primary-foreground transition-all duration-300',
                                              children: _jsx(Play, {
                                                className:
                                                  'h-4 w-4 group-hover/btn:translate-x-0.5 transition-transform'
                                              })
                                            })
                                          ]
                                        })
                                  ...
                                  : // Enhanced collapsed view
                                    _jsx('div', {
                                      className:
                                        'flex items-center justify-center h-full bg-transparent',
                                      children: _jsx('div', {
                                        className: 'transform rotate-90 whitespace-nowrap',
                                        children: _jsx('span', {
                                          className:
                                            'uppercase tracking-[0.2em] transition-colors text-indigo-950 font-semibold text-sm',
                                          children: feature.title
                                        })
                                      })
                                    })
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Button, {
                      ...
                      size: 'icon-lg',
                      className:
                        'border-2 hover:scale-110 transition-all duration-300 shadow-md hover:shadow-lg',
                      'aria-label': 'Navigate to previous feature',
                      children: _jsx(ChevronLeft, { className: 'h-5 w-5' })
                    }),
                    _jsx('div', {
