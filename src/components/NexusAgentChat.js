...
What specific aspect of SFDR compliance would you like to address first?`;
    ...
    const handleFormSubmit = async () => {
      ...
      try {
        ...
        const response = {
          ...
          issues:
            backendResponse.data?.confidence && backendResponse.data.confidence < 0.7
              ? [
                  {
    ...
    return _jsx(motion.div, {
      ...
      children: _jsxs(Card, {
        className: 'h-[700px] flex flex-col shadow-lg',
        children: [
          _jsx(CardHeader, {
            className: 'flex-shrink-0 bg-gradient-to-r from-blue-50 to-indigo-50 border-b',
            children: _jsxs('div', {
                    ...
                    _jsxs(motion.div, {
                      ...
                      children: [
                        ...
                        _jsx(motion.div, {
                          ...
                          className:
                            'absolute -top-1 -right-1 h-3 w-3 bg-green-500 rounded-full border-2 border-white'
                        })
                      ]
                    }),
                    _jsx('div', {
                      children: _jsx(CardTitle, {
                        className:
                          'text-xl bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent font-normal',
                        children: agentPersonality.name
                      })
                    })
                  ]
                }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs(Badge, {
                      ...
                      children: [_jsx(Shield, { className: 'h-3 w-3 mr-1' }), 'Secure']
                    }),
                    _jsx(Button, {
                      variant: 'outline',
                      size: 'sm',
                      ...
                      children: showFormMode ? 'Chat Mode' : 'Form Mode'
                    }),
                    _jsxs('div', {
                      className: 'flex items-center gap-2',
                      children: [
                        _jsx(Label, { className: 'text-xs', children: 'AI Strategy' }),
                        _jsxs(Select, {
                          value: aiStrategy,
                          onValueChange: v => setAiStrategy(v),
                          children: [
                            _jsx(SelectTrigger, {
                              className: 'h-8 w-[160px]',
                              children: _jsx(SelectValue, { placeholder: 'Select strategy' })
                            }),
                            _jsxs(SelectContent, {
                              children: [
                                _jsx(SelectItem, {
                                ...
                                _jsx(SelectItem, { value: 'primary', children: 'Primary LLM' }),
                                _jsx(SelectItem, { value: 'secondary', children: 'Secondary LLM' })
                              ]
                            })
                          ]
                        })
          ...
          _jsx(CardContent, {
            ...
            children: !showFormMode
              ? // Chat Mode
                _jsxs(_Fragment, {
                  children: [
                    _jsx(ScrollArea, {
                      className: 'flex-1 px-4 max-h-[500px]',
                      children: _jsxs('div', {
                    ...
                    _jsx('div', {
                      ...
                      children: _jsx(EnhancedInput, {
                        value: inputMessage,
                        onChange: setInputMessage,
                        onSubmit: handleSendMessage,
                        onVoiceInput: handleVoiceInput,
                        placeholder:
                          'Ask about SFDR compliance, fund classification, or submit data for validation...',
                        disabled: isLoading,
                        isLoading: isLoading,
                        maxLength: 2000,
                        suggestions: [
                  ...
                  children: [
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsxs('div', {
                          children: [
                            _jsx(Label, { htmlFor: 'entityId', children: 'Entity ID *' }),
                            _jsx(Input, {
                              id: 'entityId',
                    ...
                    _jsxs('div', {
                      children: [
                        _jsx(Label, { htmlFor: 'fundName', children: 'Fund Name *' }),
                        _jsx(Input, {
                          id: 'fundName',
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsxs('div', {
                          children: [
                            _jsx(Label, { htmlFor: 'fundType', children: 'Fund Type' }),
                            _jsxs('select', {
                              id: 'fundType',
                              ...
                              children: [
                                _jsx('option', { value: 'UCITS', children: 'UCITS' }),
                                _jsx('option', { value: 'AIF', children: 'AIF' }),
                                _jsx('option', { value: 'ELTIF', children: 'ELTIF' }),
                                _jsx('option', { value: 'MMF', children: 'MMF' })
                              ]
                            })
                          ]
                        }),
                        _jsxs('div', {
                          children: [
                            _jsx(Label, {
                              htmlFor: 'targetArticle',
                              children: 'Target Article Classification'
                            }),
                            _jsxs('select', {
                              id: 'targetArticle',
                              className: 'w-full p-2 border border-gray-300 rounded-md',
                              value:
                                formData.fundProfile?.targetArticleClassification || 'Article8',
                              onChange: e =>
                                setFormData(prev => ({
                                  ...prev,
                                  fundProfile: {
                              ...
                              children: [
                                _jsx('option', {
                                  value: 'Article6',
                                  children: 'Article 6 (Basic)'
                                }),
                                _jsx('option', {
                                  value: 'Article8',
                                  children: 'Article 8 (ESG Characteristics)'
                                }),
                                _jsx('option', {
                                  value: 'Article9',
                                  children: 'Article 9 (Sustainable Investment)'
                                })
                              ]
                            })
                          ]
                    ...
                    _jsxs('div', {
                      children: [
                        ...
                        _jsx(Textarea, {
                          ...
                          placeholder:
                            "Describe the fund's investment objective and ESG approach...",
                          rows: 3
                        })
                      ]
                    }),
                      ...
                      children: [
                        ...
                        _jsx(Button, {
                          ...
                          children: isLoading
                            ? _jsxs(_Fragment, {
                                children: [
                                  _jsx(Loader2, { className: 'w-4 h-4 mr-2 animate-spin' }),
                                  'Validating...'
                                ]
                              })
                            : _jsxs(_Fragment, {
                                children: [
                                  _jsx(Shield, { className: 'w-4 h-4 mr-2' }),
