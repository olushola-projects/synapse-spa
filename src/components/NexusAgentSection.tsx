      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
            AI-powered SFDR compliance validation that helps financial institutions ensure regulatory compliance with confidence.
          </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start gap-3 p-4 bg-white rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" className="w-full sm:w-auto border-blue-200 text-blue-600 hover:bg-blue-50">
                Learn More
              </Button>
            </div>
          </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="bg-gray-100 rounded-lg p-3 max-w-[80%]">
                      <p className="text-sm text-gray-800">
                        Welcome! I can help validate your SFDR fund classification. 
                        What type of fund would you like to analyze?
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-100 rounded-lg p-3 max-w-[80%]">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-600">
                          <strong>Classification:</strong> Article 8 (Confirmed)<br/>
                          <strong>Confidence:</strong> 94.2%<br/>
