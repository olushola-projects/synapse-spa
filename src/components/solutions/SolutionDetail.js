  ...
  return _jsx(
    motion.div,
    {
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            className: `hidden md:flex items-center justify-center w-24 h-24 rounded-xl bg-gradient-to-br ${solution.color} text-white shadow-lg`,
            children: _jsx(solution.icon, { className: 'h-10 w-10' })
          }),
          _jsxs('div', {
            className: 'flex-1',
            children: [
              ...
              _jsx('p', {
                className: 'text-slate-700 mb-6 text-lg',
              ...
              _jsx('div', {
                ...
                children: _jsxs(Button, {
                  ...
                  children: ['Explore ', solution.title]
                })
              })
            ]
          })
