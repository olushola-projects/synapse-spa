...
function evaluateMetric(value, thresholds) {
    const { WARNING_THRESHOLD, CRITICAL_THRESHOLD, WARNING_THRESHOLD_MB, CRITICAL_THRESHOLD_MB, WARNING_THRESHOLD_PERCENT, CRITICAL_THRESHOLD_PERCENT, WARNING_MS, CRITICAL_MS, isHigherBetter = false } = thresholds;
