    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (data) {
                ...
                setActiveAlerts(data.alerts.map(alert => ({ ...alert, category: 'system', type: 'performance' })));
        ...
        const handleNewAlert = (alert) => {
            setActiveAlerts(prevAlerts => [{ ...alert, category: 'system', type: 'performance' }, ...prevAlerts]);
        };
