...
export function RealTimeMonitoringDashboard() {
  ...
  if (isLoading) {
    return _jsx('div', {
      ...
      children: Array.from({ length: 4 }).map((_, index) => _jsx(MonitoringCardSkeleton, {}, index))
    });
  }
  if (!overview) {
    return null;
  ...
  return _jsxs('div', {
    className: 'space-y-6',
    children: [
      _jsx(MonitoringOverview, { overview: overview, alerts: activeAlerts }),
      _jsxs(Tabs, {
        defaultValue: 'alerts',
        className: 'space-y-4',
        children: [
          _jsxs(TabsList, {
            children: [
              _jsxs(TabsTrigger, {
                value: 'alerts',
                children: ['Active Alerts (', activeAlerts.length, ')']
              }),
              _jsx(TabsTrigger, { value: 'metrics', children: 'Metrics' }),
              _jsx(TabsTrigger, { value: 'compliance', children: 'SFDR Compliance' }),
          ...
          _jsx(TabsContent, {
            value: 'metrics',
            className: 'space-y-4',
            children: _jsx(MetricsTab, {})
          }),
          _jsx(TabsContent, {
            value: 'compliance',
            className: 'space-y-4',
            children: _jsx(ComplianceTab, { overview: overview })
          }),
          _jsx(TabsContent, {
            value: 'security',
            className: 'space-y-4',
