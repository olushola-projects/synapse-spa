...
const FAQSection = () => {
    return (_jsx("section", { id: 'faq', className: 'py-20 bg-gray-50', children: _jsxs("div", { className: 'container mx-auto px-4 sm:px-6 lg:px-8', children: [_jsxs("div", { className: 'text-center mb-16', children: [_jsx("h2", { className: 'text-3xl md:text-4xl font-display font-bold mb-4', children: "Frequently Asked Questions" }), _jsx("p", { className: 'text-lg text-gray-600 max-w-3xl mx-auto', children: "Find answers to common questions about Synapses and how it can transform your GRC experience." })] }), _jsx("div", { className: 'max-w-3xl mx-auto', children: _jsx(Accordion, { type: 'single', collapsible: true, className: 'mb-12', children: faqs.map((faq, index) => (_jsxs(AccordionItem, { value: `item-${index}`, children: [_jsx(AccordionTrigger, { className: 'text-lg font-medium text-left', children: faq.question }), _jsx(AccordionContent, { className: 'text-gray-600', children: faq.answer })] }, index))) }) }), _jsx("div", { className: 'text-center mt-12', children: _jsxs("p", { className: 'text-gray-500', children: ["Still have questions?", ' ', _jsx("a", { href: '#contact', className: 'text-synapse-primary font-medium hover:underline', children: "Contact our team" })] }) })] }) }));
};
