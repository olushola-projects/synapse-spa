...
const logos = [
  {
    ...
    alt: "OpenAI logo",
    className: "h-8 md:h-10 hover:scale-110 transition-transform"
  },
  {
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4" ref={containerRef}>
        ...
        <div className="overflow-x-auto">
          <div className="flex justify-center items-center space-x-8 md:space-x-16 min-w-max mx-auto">
            {logos.map((logo, index) => (
              <motion.div
                ...
                aria-label={`${logo.name} - Integration Partner`}
              >
                <img
                  src={logo.src}
                  alt={logo.alt}
                  className={`partner-logo w-auto object-contain grayscale hover:grayscale-0 transition-all duration-300 ${logo.className || ''}`}
                  loading="lazy"
                  width="auto"
                  height="40"
                />
