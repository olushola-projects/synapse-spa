        ...
        <div className="w-full max-w-7xl mx-auto flex items-center justify-between px-4 md:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link to="/nexus-agent" className="text-slate-600 hover:text-blue-600 transition-colors font-medium text-sm tracking-wide">Nexus Agent</Link>
        ...
        {mobileMenuOpen && (
          ...
          >
            <nav className="container mx-auto p-4 flex flex-col gap-4">
              ...
              <Link to="/nexus-agent" className="text-blue-600 hover:text-blue-700 transition-colors py-2 px-4 rounded-md hover:bg-blue-50 font-medium">Nexus Agent</Link>
