      ...
      <header className='sticky top-0 z-50 w-full bg-white/95 backdrop-blur-sm border-b border-slate-200/60 transition-all duration-200 shadow-sm'>
        <div className='w-full max-w-7xl mx-auto flex items-center justify-between px-4 md:px-6 lg:px-8 py-4'>
          <div className='flex items-center gap-8'>
            <Link
              to='/'
              className='text-3xl font-bold text-blue-600 flex items-center gap-2 hover:text-blue-700 transition-colors'
            >
              Synapses
            </Link>
          ...
          <div className='hidden md:flex items-center gap-3'>
            <div onClick={openInviteDialog} className='cursor-pointer'>
              <Button
                variant='outline'
                className='border-2 border-blue-200 text-blue-600 bg-transparent hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 font-medium px-6 py-2 rounded-lg'
              >
                Invite
              </Button>
            </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            <nav className='container mx-auto p-4 flex flex-col gap-4'>
              <Link
                to='/'
                className='text-blue-600 hover:text-blue-700 transition-colors py-2 px-4 rounded-md hover:bg-blue-50 font-medium'
              >
                Home
              </Link>
              <Link
              ...
              <div
                ...
                className='text-blue-600 hover:text-blue-700 transition-colors py-2 px-4 rounded-md hover:bg-blue-50 cursor-pointer'
              >
                <Button
                  variant='outline'
                  className='border-2 border-blue-600 text-blue-600 bg-transparent hover:bg-blue-600 hover:text-white transition-colors font-medium w-full'
                >
                  Invite
                </Button>
              </div>
              <div
                ...
                className='text-blue-600 hover:text-blue-700 transition-colors py-2 px-4 rounded-md hover:bg-blue-50 cursor-pointer'
              >
                <Button className='mt-2 w-full bg-blue-600 text-white hover:bg-blue-700 font-medium'>
                  Get Early Access
                </Button>
              </div>
            </nav>
