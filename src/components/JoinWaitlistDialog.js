  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { className: 'text-xl', children: 'Join the Synapses Waitlist' }),
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsxs('div', {
                    className: 'grid gap-2',
                    children: [
                      _jsx(Label, { htmlFor: 'email', children: 'Work Email' }),
                      _jsx(Input, {
                        id: 'email',
                        type: 'email',
                  ...
                  _jsxs('div', {
                    className: 'grid gap-2',
                    children: [
                      _jsx(Label, { htmlFor: 'title', children: 'Job Title' }),
                      _jsx(Input, {
                        id: 'title',
                        type: 'text',
                  ...
                  _jsxs('div', {
                    className: 'grid gap-2',
                    children: [
                      _jsx(Label, { htmlFor: 'country', children: 'Country' }),
                      _jsxs(Select, {
                        children: [
                          _jsx(SelectTrigger, {
                            id: 'country',
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx(Label, { htmlFor: 'company', children: 'Company' }),
                      _jsx(Input, {
                        id: 'company',
                        type: 'text',
