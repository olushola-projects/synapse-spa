                ...
                <div>
                  ...
                  <div className='flex flex-col gap-1'>
                    ...
                    <p className='font-normal text-xs text-slate-900'>
                      Continuously Expanding Jurisdictions
                    </p>
                  </div>
                </div>

                <div>
                  <h4 className='text-gray-900 mb-1 text-base font-semibold'>
                ...
                {agentData.map((agent, index) => <CarouselItem key={index} className='md:basis-[100%] lg:basis-[100%]'>
                    <div className='p-1 h-full' onClick={() => openFormDialog(`Learn about ${agent.name} - ${agent.role}`)}>
                      <Card className='relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 h-full cursor-pointer group border border-gray-200'>
                        ...
                        <CardContent className="p-6 relative z-10 h-full flex flex-col bg-slate-200 px-px py-[4px]">
