        ...
        <div className='grid md:grid-cols-2 gap-12 items-start'>
          ...
          >
            <motion.h2
              ...
              className='text-3xl md:text-[2.75rem] tracking-tight leading-[1.15] text-gray-900 -tracking-[0.5px] font-normal'
            >
            ...
            <motion.div variants={itemVariants} className='pt-2'>
              <Button
                ...
                className='text-white py-6 text-base font-medium rounded-full bg-blue-700 hover:bg-blue-600 px-[30px]'
              >
