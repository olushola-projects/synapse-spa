          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <p className="text-[1.125rem] text-[#4B4B4B] leading-relaxed font-normal">
                Seamlessly integrate AI agents to streamline compliance, enhance
                decisions, and reduce manual work across your existing GRC
                ecosystem.
              </p>
            ...
            <motion.div variants={itemVariants} className="pt-2">
              <Button
                ...
                onClick={() =>
                  openFormDialog("Explore Synapses for enterprises")
                }
              >
                ...
                {agentData.map((agent, index) => (
                  ...
                  >
                    <div
                      ...
                      onClick={() =>
                        openFormDialog(
                          `Learn about ${agent.name} - ${agent.role}`
                        )
                      }
                    >
