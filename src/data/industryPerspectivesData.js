import { createCoinsIcon, createScaleIcon, createShieldAlertIcon, createBuilding2Icon, createFileTextIcon, createLineChartIcon, createBrainIcon, createGraduationCapIcon } from '@/utils/iconUtils';
export const industryPerspectives = [
    {
        ...
        quotation: "The future of financial compliance isn't about more rules—it's about smarter oversight of increasingly autonomous systems.",
    ...
    },
    {
        ...
        quotation: 'Our regulatory approach must evolve in lockstep with technological innovation while ensuring the core principles of fairness and accountability remain paramount.',
    ...
    },
    {
        ...
        quotation: "The boards that survive the AI revolution will be those that understand it's not just a technology issue but a fundamental governance challenge.",
    ...
    },
    {
        ...
        quotation: "The institutions showing the most significant gains aren't those with the most advanced AI, but those with the most thoughtful implementation frameworks.",
    ...
    },
    {
        ...
        quotation: 'Our risk posture is only as strong as our weakest vendor. In the age of agentic AI, we cannot afford governance gaps anywhere in our ecosystem.',
    ...
    },
    {
        ...
        quotation: "The future of risk management isn't AI replacing humans—it's AI amplifying human judgment while humans provide the ethical guardrails for AI.",
    ...
    },
    {
        ...
        quotation: 'We must move from asking whether AI systems follow rules to asking whether they achieve outcomes that are fair, transparent, and beneficial to society.',
    ...
    },
    {
        ...
        quotation: 'Central banks must maintain the highest standards of governance as they adopt AI, as public trust in monetary systems depends on transparent and accountable decision-making.',
    ...
    },
    {
        ...
        quotation: 'The compliance function is undergoing its most significant transformation since the 2008 financial crisis, driven by the need to adapt to AI-powered operations.',
