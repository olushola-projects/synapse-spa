...
export const authMiddleware = [requestLogger, securityHeaders, debugAuth, authenticateJWT];
export const optionalAuthMiddleware = [requestLogger, securityHeaders, debugAuth];
