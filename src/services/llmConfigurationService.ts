...
export class LLMConfigurationService {
  ...
  static getInstance(): LLMConfigurationService {
   ...
   */
  getDefaultStrategy(): LLMStrategy {
   ...
   */
  getStrategyModels(strategyId: string): LLMModel[] {
   ...
   */
  getBestModelForTask(task: string, strategyId?: string): LLMModel | null {
   ...
   */
  updateConfiguration(updates: Partial<LLMConfiguration>): void {
