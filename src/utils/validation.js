...
export const passwordSchema = z
    ...
    .refine(password => (SecurityUtils.config.password.requireUppercase ? /[A-Z]/.test(password) : true), { message: 'Password must contain at least one uppercase letter' })
    .refine(password => (SecurityUtils.config.password.requireLowercase ? /[a-z]/.test(password) : true), { message: 'Password must contain at least one lowercase letter' })
    .refine(password => (SecurityUtils.config.password.requireNumber ? /[0-9]/.test(password) : true), { message: 'Password must contain at least one number' })
    .refine(password => SecurityUtils.config.password.requireSpecial ? /[^A-Za-z0-9]/.test(password) : true, { message: 'Password must contain at least one special character' });
/**
