...
export const validateCsrfToken = (token) => {
    const storedToken = secureStore.get('csrfToken');
...
const getEncryptionKey = () => {
    ...
    let key = secureStore.get('encryptionKey');
    if (!key) {
        // Generate a new key
 ...
 */
export const generateSecureToken = (length = SECURITY_CONSTANTS.TOKEN.DEFAULT_LENGTH) => {
