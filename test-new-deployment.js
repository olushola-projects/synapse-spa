        ...
        if (healthResponse.status === 200) {
            ...
            if (metricsResponse.status === 200) {
                ...
                if (classifyResponse.status === 200) {
                    ...
                    console.log(`✅ Qwen API: ${metricsData.api_keys_configured?.qwen ? '🔑 Configured' : '❌ Missing'}`);
                    console.log(`✅ OpenAI API: ${metricsData.api_keys_configured?.openai ? '🔑 Configured' : '❌ Missing'}`);
                    ...
                    console.log(`✅ AI Features: ${metricsData.features?.includes('AI-powered classification') ? '🤖 ACTIVE' : '❌ Inactive'}`);
