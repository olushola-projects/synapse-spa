  ...
  test.describe('WCAG Standards Compliance', () => {
    ...
    test('should have proper focus indicators', async ({ page }) => {
      ...
      const focusableElements = await page
        .locator('button, input, textarea, select, a, [tabindex]')
        .all();
  ...
  test.describe('Screen Reader Compatibility', () => {
    test('should have proper semantic HTML structure', async ({ page }) => {
      ...
      const semanticElements = await page
        .locator('nav, main, section, article, aside, header, footer')
        .all();
  ...
  test.describe('Error Handling & Recovery', () => {
    ...
    test('should provide accessible success messages', async ({ page }) => {
      ...
      await page
        ...
        .fill('A fund focused on sustainable investments');
      await page.getByTestId('classify-button').click();
