-- Enterprise Security Hardening & RegTech Compliance Remediation
...
-- 4. Enterprise Data Quality Constraints
-- Add NOT NULL constraints for critical business data
ALTER TABLE public.compliance_assessments 
ALTER COLUMN fund_name SET NOT NULL,
ALTER COLUMN entity_id SET NOT NULL,
ALTER COLUMN target_article SET NOT NULL;

-- 5. SFDR Regulatory Compliance Table
...
-- 6. Performance Monitoring Table for SLA Tracking
...
-- 7. Update timestamp trigger for regulatory compliance
